---
type: "Workflow"
title: "Bullseye Framework source-aware workflow"
description: "Verify-first workflow for producing a reviewable traction-channel test portfolio brief."
---
...
7. Draft the traction-channel test portfolio brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
8. Require explicit confirmation before launch campaigns, contact people, collect data, spend budgets, make platform changes, or represent attribution, traction, conversion, or approval.
