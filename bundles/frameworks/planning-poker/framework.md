---
type: "Framework"
title: "Planning Poker source-aware framework guide"
description: "Evidence-grounded planning, review, and authority boundaries for Planning Poker."
tags:
- "framework"
- "source-aware"
resource: "https://wingman-sw.com/articles/planning-poker"
okb_bundle_id: planning-poker
timestamp: "2026-08-15T00:00:00Z"
---
# Planning Poker Source-Aware Framework Guide
...
5. Produce the smallest reviewable estimation session evidence and uncertainty brief with options, risks, dependencies, validation, and stop conditions.
6. Obtain explicit confirmation before assign work or deadlines, convert points mechanically to time, evaluate employee performance, commit delivery, publish forecasts, or represent certainty or approval.

## Guardrails

- Do not invent scope completeness, participant knowledge, estimate comparability, effort, duration, capacity, delivery date, team performance, certainty, or approval.
