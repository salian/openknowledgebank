---
type: "Workflow"
title: "12 Brand Archetypes source-aware workflow"
description: "Verify-first workflow for producing a reviewable brand archetype positioning brief."
---
...
7. Draft the brand archetype positioning brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
8. Require explicit confirmation before publish brand claims, use protected assets, change identity systems, launch campaigns, spend funds, or represent audience response or approval.
