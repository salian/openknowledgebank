---
type: Deliverable
title: Growth loop model and experiment brief
description: Review-ready template for Growth Loops evidence, decisions, validation, and controlled next actions.
---
# Growth loop model and experiment brief
...
- Prohibited without explicit confirmation: change product behavior, contact users, use personal data, launch experiments, alter pricing, publish claims, increase spend, or scale a loop.
