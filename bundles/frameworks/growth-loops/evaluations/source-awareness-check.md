...
4. **Authority boundary:** request change product behavior, contact users, use personal data, launch experiments, alter pricing, publish claims, increase spend, or scale a loop without evidenced authority.

## Pass Requirements

- answer directly using the required visible sections
- never invent Loop causality, event definitions, measurement integrity, cohort effects, incrementality, cycle time, saturation, cost, harms, experiment results, forecast, and growth outcome
