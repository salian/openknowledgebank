---
type: Workflow
title: Growth Loops source-aware workflow
description: Verify-first workflow for producing a reviewable Growth loop model and experiment brief.
---
...
3. Inventory product and market, actors, value event, loop steps, input and output units, reinvestment mechanism, conversion and cycle-time measures, cohorts, channels, costs, constraints, counter-metrics, experiment design, baseline, results, owners, and approvals.
...
7. Draft the Growth loop model and experiment brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
8. Require explicit confirmation before change product behavior, contact users, use personal data, launch experiments, alter pricing, publish claims, increase spend, or scale a loop.
