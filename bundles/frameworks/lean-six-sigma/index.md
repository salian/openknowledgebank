...
description: Source-aware guidance for applying Lean Six Sigma to evidence, decisions, validation, and qualified review.
category: frameworks
version: 0.1.0
tags:
- lean
...
- Lean Six Sigma
problems_solved:
- Prepare a source-grounded Lean Six Sigma application brief.
...
- Lean Six Sigma
deliverables:
- Lean Six Sigma application brief
commands: []
skills: []
evaluations:
- Lean Six Sigma source-awareness check
trust_tier: trusted
status: beta
license: CC-BY-4.0
related_bundles:
...
content_risk:
  ...
  professional_review:
    status: not_reviewed
    required_qualification: A qualified process-improvement, quality, statistics, safety, finance, or domain professional appropriate to the process and decision.
limitations:
...
Use this bundle to prepare a reviewable **Lean Six Sigma application brief** without inventing local facts, configuration, evidence, results, permissions, or authority.
...
- [Lean Six Sigma Source-Aware Guide](framework.md)
- [Source-aware workflow](workflows/source-aware-workflow.md)
- [Lean Six Sigma application brief](deliverables/lean-six-sigma-brief.md)
