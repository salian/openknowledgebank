---
type: Workflow
title: Lean Six Sigma source-aware workflow
description: Verify-first workflow for producing a reviewable Lean Six Sigma application brief.
---
...
7. Draft the Lean Six Sigma application brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
