---
type: Workflow
title: Customer Success QBR Framework source-aware workflow
description: Verify-first workflow for producing a reviewable Customer success QBR evidence brief.
---
...
3. Inventory review period, contract and objectives, stakeholders, prior commitments, product adoption, support and service records, outcome measures, health inputs, risks, opportunities, roadmap evidence, decisions, actions, owners, dates, and approvals.
...
7. Draft the Customer success QBR evidence brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
8. Require explicit confirmation before share customer data, present unsupported outcomes, promise roadmap items, alter commercial terms, assign commitments, contact executives, or make renewal decisions.
