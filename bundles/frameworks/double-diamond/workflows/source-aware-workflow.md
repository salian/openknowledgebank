---
type: Workflow
title: Double Diamond source-aware workflow
description: Verify-first workflow for producing a reviewable Double Diamond design-decision brief.
---
...
3. Inventory challenge, affected people, research plan, consent, evidence, assumptions, insights, problem definitions, alternatives, prototypes, accessibility criteria, test methods, feedback, decision criteria, constraints, risks, owners, and approvals.
...
7. Draft the Double Diamond design-decision brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
8. Require explicit confirmation before contact participants, collect personal data, select a problem or solution, discard alternatives, publish research, claim validation, or commit delivery resources.
