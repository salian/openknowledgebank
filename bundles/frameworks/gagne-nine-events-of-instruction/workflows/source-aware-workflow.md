---
type: Workflow
title: Gagne's Nine Events of Instruction source-aware workflow
description: Verify-first workflow for producing a reviewable Nine Events instructional design brief.
---
...
3. Inventory learners, context, prerequisites, learning objectives, content, accessibility needs, language, technology, attention strategy, prior-knowledge evidence, guidance, practice, feedback, assessment criteria, transfer context, timing, facilitator capability, pilot evidence, owners, and approvals.
...
7. Draft the Nine Events instructional design brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
8. Require explicit confirmation before collect learner data, expose accommodations, deploy training, grade or certify learners, make employment decisions, claim learning effectiveness, or mandate instructional changes.
