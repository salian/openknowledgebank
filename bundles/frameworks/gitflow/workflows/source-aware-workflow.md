---
type: "Workflow"
title: "GitFlow source-aware workflow"
description: "Verify-first workflow for producing a reviewable branching and release workflow decision brief."
---
...
7. Draft the branching and release workflow decision brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
8. Require explicit confirmation before change branch protections or release policy, merge or deploy code, delete branches, alter CI/CD, or represent release safety or approval.
