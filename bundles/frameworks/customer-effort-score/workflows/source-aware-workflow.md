---
type: Workflow
title: Customer Effort Score source-aware workflow
description: Verify-first workflow for producing a reviewable Customer Effort Score measurement brief.
---
...
3. Inventory decision question, customer population, interaction type, survey wording, scale direction, channels, invitation logic, consent, response records, exclusions, dates, segments, calculation, uncertainty, benchmarks, follow-up evidence, owners, and approvals.
...
7. Draft the Customer Effort Score measurement brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
8. Require explicit confirmation before contact customers, expose response data, change service policy, publish scores or benchmarks, claim causality, rank employees, or commit resources.
