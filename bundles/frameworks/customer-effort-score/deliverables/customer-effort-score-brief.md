---
type: Deliverable
title: Customer Effort Score measurement brief
description: Review-ready template for Customer Effort Score evidence, decisions, validation, and controlled next actions.
---
...
- Prohibited without explicit confirmation: contact customers, expose response data, change service policy, publish scores or benchmarks, claim causality, rank employees, or commit resources.
