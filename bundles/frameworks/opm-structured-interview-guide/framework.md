---
type: "Framework"
title: "OPM Structured Interview Guide source-aware framework guide"
description: "Evidence-grounded planning, review, and authority boundaries for OPM Structured Interview Guide."
tags:
- "framework"
- "source-aware"
resource: "https://www.opm.gov/policy-data-oversight/assessment-and-selection/structured-interviews/guide.pdf"
okb_bundle_id: opm-structured-interview-guide
timestamp: "2026-08-15T00:00:00Z"
---
# OPM Structured Interview Guide Source-Aware Framework Guide
...
5. Produce the smallest reviewable structured interview job-analysis, question, rating, administration, and fairness brief with options, risks, dependencies, validation, and stop conditions.
6. Obtain explicit confirmation before collect applicant data, create or expose questions, interview, score, rank, reject, hire, make accommodations, or represent competence, validity, fairness, or compliance.

## Guardrails

- Do not invent job requirement, question validity, candidate identity or competence, rating meaning, interviewer consistency, accessibility, fairness, disparate impact, hiring outcome, or approval.
