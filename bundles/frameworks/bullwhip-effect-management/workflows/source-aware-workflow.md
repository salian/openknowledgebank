---
type: "Workflow"
title: "Bullwhip Effect Management source-aware workflow"
description: "Verify-first workflow for producing a reviewable bullwhip diagnosis and mitigation brief."
---
...
7. Draft the bullwhip diagnosis and mitigation brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
8. Require explicit confirmation before change forecasts, inventory, orders, prices, allocations, suppliers, or production; spend funds; or represent service, savings, or resilience outcomes.
