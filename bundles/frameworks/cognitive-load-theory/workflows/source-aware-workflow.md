---
type: "Workflow"
title: "Cognitive Load Theory source-aware workflow"
description: "Verify-first workflow for producing a reviewable cognitive-load instructional design brief."
---
...
7. Draft the cognitive-load instructional design brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
8. Require explicit confirmation before diagnose learners, set grades, deny progression, make accommodation decisions, or represent cognitive state or learning effects.
