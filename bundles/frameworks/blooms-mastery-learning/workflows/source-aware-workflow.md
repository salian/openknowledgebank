---
type: "Workflow"
title: "Bloom's Mastery Learning source-aware workflow"
description: "Verify-first workflow for producing a reviewable mastery-learning design and evidence brief."
---
...
7. Draft the mastery-learning design and evidence brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
8. Require explicit confirmation before set consequential grades, diagnose learners, deny progression, make accommodation decisions, or represent mastery, equity, or learning outcomes.
