---
type: "Framework"
title: "Trunk-Based Development source-aware framework guide"
description: "Evidence-grounded planning, review, and authority boundaries for Trunk-Based Development."
tags:
- "framework"
- "source-aware"
resource: "https://trunkbaseddevelopment.com/"
okb_bundle_id: trunk-based-development
timestamp: "2026-08-15T00:00:00Z"
---
# Trunk-Based Development Source-Aware Framework Guide
...
5. Produce the smallest reviewable integration, branch, CI, release, and recovery decision brief with options, risks, dependencies, validation, and stop conditions.
6. Obtain explicit confirmation before change branch protections or review policy, merge or delete branches, enable flags, alter CI/CD, deploy code, or represent integration, quality, release safety, or approval.

## Guardrails

- Do not invent repository state, team readiness, review sufficiency, test reliability, compatibility, flag safety, merge readiness, deployment result, rollback effectiveness, or approval.
