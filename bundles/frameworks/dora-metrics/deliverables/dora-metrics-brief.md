---
type: Deliverable
title: DORA measurement and improvement brief
description: Review-ready template for DORA Metrics evidence, decisions, validation, and controlled next actions.
---
...
- Prohibited without explicit confirmation: instrument systems, access employee data, publish rankings, compare teams, set targets, change delivery processes, or make employment decisions.
