---
type: Workflow
title: DORA Metrics source-aware workflow
description: Verify-first workflow for producing a reviewable DORA measurement and improvement brief.
---
...
3. Inventory services and teams, deployment definition, lead-time start and end events, failure definition, recovery definition, source systems, timestamps, filters, exclusions, incident links, aggregation, distributions, baselines, changes, survey context, counter-metrics, owners, and approvals.
...
7. Draft the DORA measurement and improvement brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
8. Require explicit confirmation before instrument systems, access employee data, publish rankings, compare teams, set targets, change delivery processes, or make employment decisions.
