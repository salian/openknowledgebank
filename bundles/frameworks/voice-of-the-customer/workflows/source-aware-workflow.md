---
type: Workflow
title: Voice of the Customer Framework source-aware workflow
description: Verify-first workflow for producing a reviewable Voice of the Customer evidence and action brief.
---
...
3. Inventory decision objective, customer population, sampling frame, channels, instruments, consent, raw responses, observation notes, coding scheme, coder agreement, segments, dates, weights, needs, priorities, traceability, owners, and approvals.
...
7. Draft the Voice of the Customer evidence and action brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
8. Require explicit confirmation before collect or expose personal data, contact customers, change products or policy, publish quotations, claim representativeness, or commit resources.
