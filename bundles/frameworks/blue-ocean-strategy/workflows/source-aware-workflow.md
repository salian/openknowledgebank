---
type: "Workflow"
title: "Blue Ocean Strategy source-aware workflow"
description: "Verify-first workflow for producing a reviewable value-innovation and ERRC decision brief."
---
...
7. Draft the value-innovation and ERRC decision brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
8. Require explicit confirmation before commit strategy, discontinue offerings, enter markets, set prices, spend funds, publish competitive claims, or represent demand or commercial outcomes.
