---
type: Deliverable
title: Material Requirements Planning (MRP) / MRP II application brief
description: Review-ready template for Material Requirements Planning (MRP) / MRP II evidence, decisions, validation, and controlled next actions.
---
# Material Requirements Planning (MRP) / MRP II application brief
...
- Prohibited without explicit confirmation: adopt recommendations, change live processes or controls, approve financial or audit conclusions, commit resources, or communicate decisions externally.
