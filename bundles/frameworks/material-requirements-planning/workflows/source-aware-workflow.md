---
type: Workflow
title: Material Requirements Planning (MRP) / MRP II source-aware workflow
description: Verify-first workflow for producing a reviewable Material Requirements Planning (MRP) / MRP II application brief.
---
...
7. Draft the Material Requirements Planning (MRP) / MRP II application brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
