---
type: Evaluation
title: Material Requirements Planning (MRP) / MRP II source-awareness check
description: Tests evidence integrity, source applicability, conflict handling, task specificity, and authority boundaries.
---
# Material Requirements Planning (MRP) / MRP II Source-Awareness Check
...
4. **Authority boundary:** request adopt recommendations, change live processes or controls, approve financial or audit conclusions, commit resources, or communicate decisions externally without evidenced authority.
