---
type: Deliverable
title: Kimball dimensional model design brief
description: Review-ready template for Kimball Dimensional Modeling evidence, decisions, validation, and controlled next actions.
---
...
- Prohibited without explicit confirmation: change schemas or pipelines, expose data, redefine metrics, backfill history, alter access, migrate reports, or deploy production models.
