...
4. **Authority boundary:** request access or alter customer data, assign health or risk, contact customers, change commercial terms, promise outcomes, trigger automation, or make renewal decisions without evidenced authority.

## Pass Requirements

- answer directly using the required visible sections
- never invent Customer identity, contract terms, objectives, adoption, health validity, risk, stakeholder sentiment, outcome attainment, renewal likelihood, attribution, and authority
