---
type: Workflow
title: International Standards on Auditing (ISA) source-aware workflow
description: Verify-first workflow for producing a reviewable International Standards on Auditing (ISA) application brief.
---
...
7. Draft the International Standards on Auditing (ISA) application brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
