...
description: Source-aware guidance for applying International Standards on Auditing (ISA) to evidence, decisions, validation, and qualified review.
category: frameworks
version: 0.1.0
tags:
- isa
...
industries:
- Accounting, financial reporting, and corporate-governance frameworks
tools:
[]
frameworks:
- International Standards on Auditing (ISA)
...
skills: []
evaluations:
- International Standards on Auditing (ISA) source-awareness check
trust_tier: trusted
status: beta
license: CC-BY-4.0
related_bundles:
...
content_risk:
  ...
  professional_review:
    status: not_reviewed
    required_qualification: A qualified independent auditor, accountant, audit-quality, legal, or regulatory professional appropriate to the engagement and jurisdiction.
limitations:
...
Use this bundle to prepare a reviewable **International Standards on Auditing (ISA) application brief** without inventing local facts, configuration, evidence, results, permissions, or authority.
...
- [International Standards on Auditing (ISA) Source-Aware Guide](framework.md)
- [Source-aware workflow](workflows/source-aware-workflow.md)
- [International Standards on Auditing (ISA) application brief](deliverables/isa-brief.md)
