---
type: "Workflow"
title: "Confidence Meter source-aware workflow"
description: "Verify-first workflow for producing a reviewable evidence-confidence and next-test brief."
---
...
7. Draft the evidence-confidence and next-test brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
8. Require explicit confirmation before commit roadmap, launch products or experiments, collect user data, spend funds, or represent evidence certainty, demand, impact, or approval.
