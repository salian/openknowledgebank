...
description: Source-aware framework bundle for test-list, red-green-refactor, test design, isolation, refactoring, coverage, and delivery review, evidence reconciliation, reviewable decisions, and controlled consequential actions.
category: frameworks
version: 0.1.0
tags:
...
- Test-Driven Development
problems_solved:
- Prepare a test-driven development review brief without fabricating local facts.
...
deliverables:
- Test-Driven Development review brief
commands: []
skills: []
evaluations:
- Test-Driven Development source-awareness check
trust_tier: trusted
status: beta
license: CC-BY-4.0
related_bundles:
...
standard_mappings:
  ...
  esco: []
limitations:
- Use the listed authoritative or identified source surfaces for general Test-Driven Development guidance; local facts, records, values, states, permissions, and results require inspected evidence.
- Task-specific work requires current evidence for requirement and behavior examples, test list, failing and passing test evidence, production code and diff, test doubles and boundaries, test command and environment, coverage meaning, refactoring evidence, CI results, owner, approvals, and rollback.
...
- Require explicit confirmation before actions that edit code or tests, run commands, install dependencies, commit or merge changes, change CI, deploy software, or claim defect prevention.
...
- [deliverables/test-driven-development-brief.md](deliverables/test-driven-development-brief.md)
