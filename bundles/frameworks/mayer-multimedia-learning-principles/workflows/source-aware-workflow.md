---
type: Workflow
title: Mayer's Principles of Multimedia Learning source-aware workflow
description: Verify-first workflow for producing a reviewable Mayer's Principles of Multimedia Learning application brief.
---
...
7. Draft the Mayer's Principles of Multimedia Learning application brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
8. Require explicit confirmation before adopt recommendations, change live processes or controls, approve financial or audit conclusions, commit resources, or communicate decisions externally.
