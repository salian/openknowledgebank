---
type: Bundle Index
title: Mayer's Principles of Multimedia Learning
description: Source-aware guidance for applying Mayer's Principles of Multimedia Learning to evidence, decisions, validation, and qualified review.
category: frameworks
version: 0.1.0
tags:
- mayer
...
problems_solved:
- Prepare a source-grounded Mayer's Principles of Multimedia Learning application brief.
...
- Mayer's Principles of Multimedia Learning
deliverables:
- Mayer's Principles of Multimedia Learning application brief
commands: []
skills: []
evaluations:
- Mayer's Principles of Multimedia Learning source-awareness check
trust_tier: trusted
status: beta
license: CC-BY-4.0
related_bundles:
...
content_risk:
  ...
  professional_review:
    status: not_reviewed
    required_qualification: A qualified instructional-design, learning-science, accessibility, privacy, or domain professional appropriate to the learners and context.
limitations:
...
okb_bundle_id: mayer-multimedia-learning-principles
...
Use this bundle to prepare a reviewable **Mayer's Principles of Multimedia Learning application brief** without inventing local facts, configuration, evidence, results, permissions, or authority.
...
- [Mayer's Principles of Multimedia Learning Source-Aware Guide](framework.md)
- [Source-aware workflow](workflows/source-aware-workflow.md)
- [Mayer's Principles of Multimedia Learning application brief](deliverables/mayer-multimedia-learning-principles-brief.md)
