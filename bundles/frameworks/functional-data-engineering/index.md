...
description: "Source-aware application of Maxime Beauchemin's functional approach to deterministic, idempotent, immutable, partition-oriented batch data processing."
category: frameworks
version: 0.1.0
tags:
- "framework"
- "source-aware"
aliases:
- "Functional Data Engineering Paradigm"
...
okb_bundle_id: functional-data-engineering
...
Use this bundle to prepare a reviewable **functional data-pipeline architecture and migration brief** without inventing local facts, qualifications, records, results, permissions, or authority.
...
Prompt-supplied facts belong under `Provided`, not `Assumed`. Never invent source semantics or rights, determinism, idempotence, partition suitability, dependency state, completeness, lineage, reliability, cost, migration result, or approval.
...
- [functional data-pipeline architecture and migration brief](deliverables/functional-data-engineering-brief.md)
