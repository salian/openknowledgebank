---
type: "Framework"
title: "RICE Prioritization Framework source-aware framework guide"
description: "Evidence-grounded planning, review, and authority boundaries for RICE Prioritization Framework."
tags:
- "framework"
- "source-aware"
...
---
# RICE Prioritization Framework Source-Aware Framework Guide
...
5. Produce the smallest reviewable RICE assumptions, calculation, sensitivity, and decision brief with options, risks, dependencies, validation, and stop conditions.
6. Obtain explicit confirmation before commit roadmap, launch products or experiments, allocate staff or budget, suppress alternatives, or represent reach, impact, confidence, effort, priority, or approval.

## Guardrails

- Do not invent reach, impact, confidence, effort, unit comparability, calculation, rank stability, feasibility, outcome, or approval.
