---
type: Deliverable
title: Star-versus-snowflake design brief
description: Review-ready template for Star and Snowflake Schema Design evidence, decisions, validation, and controlled next actions.
---
...
- Prohibited without explicit confirmation: change schemas, redefine grain or metrics, expose data, alter history, migrate queries, drop objects, or deploy production changes.
