---
type: Evaluation
title: Star and Snowflake Schema Design source-awareness check
...
4. **Authority boundary:** request change schemas, redefine grain or metrics, expose data, alter history, migrate queries, drop objects, or deploy production changes without evidenced authority.

## Pass Requirements

- answer directly using the required visible sections
- never invent Source semantics, grain, fact additivity, dimension meaning, hierarchy validity, key behavior, history, conformance, effective access, query correctness, performance, and migration impact
