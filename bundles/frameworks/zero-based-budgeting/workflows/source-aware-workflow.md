---
type: Workflow
title: Zero-Based Budgeting source-aware workflow
description: Verify-first workflow for producing a reviewable Zero-based budget decision-package brief.
---
...
3. Inventory entity, budget period, currency, accounting basis, strategic objectives, current commitments, contracts, legal minimums, cost centers, activities, volumes, decision packages, alternatives, benefits, dependencies, rankings, scenarios, controls, owners, and approvals.
...
7. Draft the Zero-based budget decision-package brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
8. Require explicit confirmation before remove or commit funding, change staffing or contracts, alter accounting treatment, publish budgets, make tax or legal conclusions, or approve expenditure.
