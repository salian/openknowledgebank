---
type: Deliverable
title: BDD behavior and acceptance brief
description: Review-ready template for Behavior-Driven Development evidence, decisions, validation, and controlled next actions.
---
...
- Prohibited without explicit confirmation: change production behavior, execute untrusted tests, modify data, deploy code, weaken controls, or claim acceptance.
