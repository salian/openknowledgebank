---
type: "Framework"
title: "Scrumban source-aware framework guide"
description: "Evidence-grounded planning, review, and authority boundaries for Scrumban."
tags:
- "framework"
- "source-aware"
resource: "https://agilealliance.org/remarks-on-the-original-scrumban-essay/"
okb_bundle_id: scrumban
timestamp: "2026-08-15T00:00:00Z"
---
# Scrumban Source-Aware Framework Guide

## Authoritative Sources

- https://agilealliance.org/remarks-on-the-original-scrumban-essay/
...
5. Produce the smallest reviewable Scrumban workflow, policy, planning, and experiment brief with options, risks, dependencies, validation, and stop conditions.
6. Obtain explicit confirmation before assign or prioritize work, impose limits, change roles or workflow, make employment decisions, publish metrics, or represent capacity, predictability, delivery, or approval.

## Guardrails

- Do not invent demand, workflow state, WIP limit, planning trigger, role assignment, capacity, flow metric, team performance, delivery outcome, or approval.
