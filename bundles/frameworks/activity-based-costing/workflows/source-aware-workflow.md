---
type: Workflow
title: Activity-Based Costing source-aware workflow
description: Verify-first workflow for producing a reviewable Activity-based costing model brief.
---
...
3. Inventory entity, period, accounting basis, general-ledger totals, resources, activities, cost pools, driver definitions, driver quantities, capacities, objects, allocation rules, reconciliations, sensitivities, owners, and approvals.
...
7. Draft the Activity-based costing model brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
8. Require explicit confirmation before change cost allocations, prices, budgets, staffing, product decisions, accounting records, tax positions, or external reporting.
