---
type: "Bundle Index"
title: "Lean Six Sigma for Finance"
description: "Source-aware finance-process improvement using Lean and Six Sigma concepts with accounting, control, measurement, statistical, and governance boundaries."
category: frameworks
version: 0.1.0
tags:
- "framework"
- "source-aware"
aliases:
- "Finance Lean Six Sigma"
- "Six Sigma for Finance"
problems_solved:
...
okb_bundle_id: six-sigma-lean-finance
...
Use this bundle to prepare a reviewable **finance-process scope, measurement, analysis, improvement, and control brief** without inventing local facts, qualifications, records, results, permissions, or authority.
...
Prompt-supplied facts belong under `Provided`, not `Assumed`. Never invent accounting treatment, process scope, waste or defect, measurement validity, baseline, cause, statistical significance, control effectiveness, savings, audit conclusion, compliance, or approval.
...
- [finance-process scope, measurement, analysis, improvement, and control brief](deliverables/six-sigma-lean-finance-brief.md)
