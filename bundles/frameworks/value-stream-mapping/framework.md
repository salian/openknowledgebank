---
type: "Framework"
title: "Value Stream Mapping source-aware framework guide"
description: "Evidence-grounded planning, review, and authority boundaries for Value Stream Mapping."
tags:
- "framework"
- "source-aware"
resource: "https://www.lean.org/lexicon-terms/value-stream-mapping/"
okb_bundle_id: value-stream-mapping
timestamp: "2026-08-15T00:00:00Z"
---
# Value Stream Mapping Source-Aware Framework Guide
...
5. Produce the smallest reviewable current-state, future-state, evidence, and improvement brief with options, risks, dependencies, validation, and stop conditions.
6. Obtain explicit confirmation before observe or collect employee or customer data, change processes, staffing, inventory, systems, suppliers, or controls; spend funds; or represent waste, flow, savings, quality, or approval.

## Guardrails

- Do not invent value stream boundary, demand, process state, timing, inventory, queue, waste, constraint, cause, future-state effect, savings, quality, safety, or approval.
