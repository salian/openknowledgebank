---
type: Workflow
title: IRS Exemption Applications: Forms 1024 and 1024-A source-aware workflow
description: Verify-first workflow for producing a reviewable exemption-application readiness brief.
---
...
7. Draft the exemption-application readiness brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
