---
type: Workflow
title: HIPAA Privacy Rule Source-Aware Triage
...
- Local evidence relevant to Privacy Rule.
- Missing documents, system records, transaction artifacts, contracts, policies, incident facts, or implementation guides.

## Steps

1. Classify the request as Privacy Rule work or route it back to the broader [HIPAA](../../hipaa/index.md) hub.
