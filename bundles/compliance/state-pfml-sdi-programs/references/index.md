...
description: Defines evidence-grounded planning, review, and controlled use for State PFML and SDI Programs.
tags:
- pfml
...
5. Produce the smallest reviewable state PFML and SDI applicability matrix with options, risks, dependencies, validation, and stop conditions.
