---
type: Bundle Index
title: State PFML and SDI Programs
description: Jurisdiction-aware review of state paid family and medical leave and state disability insurance programs.
category: compliance
version: 0.1.0
tags:
- pfml
...
- PFML and SDI
problems_solved:
- Assess State PFML and SDI Programs applicability and evidence.
...
deliverables:
- state PFML and SDI applicability matrix
commands: []
skills: []
evaluations:
- State PFML and SDI Programs source-awareness check
trust_tier: trusted
status: beta
license: CC-BY-4.0
related_bundles:
...
okb_bundle_id: state-pfml-sdi-programs
...
---
# State PFML and SDI Programs

Use this bundle to prepare a reviewable **state PFML and SDI applicability matrix** without inventing local facts, configuration, evidence, results, permissions, or authority.
...
- [state PFML and SDI applicability matrix](deliverables/state-pfml-sdi-programs-brief.md)
