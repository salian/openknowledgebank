---
type: Workflow
title: State PFML and SDI Programs source-aware workflow
description: Verify-first workflow for producing a reviewable state PFML and SDI applicability matrix.
---
...
7. Draft the state PFML and SDI applicability matrix, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
