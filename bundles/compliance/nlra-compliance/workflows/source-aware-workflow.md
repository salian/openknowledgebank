---
type: Workflow
title: National Labor Relations Act (NLRA) Compliance source-aware workflow
description: Verify-first workflow for producing a reviewable NLRA Compliance Issue Brief.
---
...
7. Draft the NLRA Compliance Issue Brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
