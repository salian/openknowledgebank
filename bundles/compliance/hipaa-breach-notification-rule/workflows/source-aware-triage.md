---
type: Workflow
title: HIPAA Breach Notification Rule Source-Aware Triage
...
- Local evidence relevant to Breach Notification Rule.
- Missing documents, system records, transaction artifacts, contracts, policies, incident facts, or implementation guides.

## Steps

1. Classify the request as Breach Notification Rule work or route it back to the broader [HIPAA](../../hipaa/index.md) hub.
