---
type: Workflow
title: LGPD Data Protection Impact Report (RIPD) source-aware workflow
description: Verify-first workflow for producing a reviewable RIPD screening and report brief.
---
...
7. Draft the RIPD screening and report brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
