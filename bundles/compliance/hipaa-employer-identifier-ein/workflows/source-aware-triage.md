---
type: Workflow
title: HIPAA Employer Identifier Standard Source-Aware Triage
...
- Local evidence relevant to Employer Identifier Standard.
- Missing documents, system records, transaction artifacts, contracts, policies, incident facts, or implementation guides.

## Steps

1. Classify the request as Employer Identifier Standard work or route it back to the broader [HIPAA](../../hipaa/index.md) hub.
