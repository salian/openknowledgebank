---
type: Workflow
title: State Unemployment Insurance Tax source-aware workflow
description: Verify-first workflow for producing a reviewable state unemployment insurance tax compliance matrix.
---
...
7. Draft the state unemployment insurance tax compliance matrix, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
