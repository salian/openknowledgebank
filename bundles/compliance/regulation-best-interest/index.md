...
description: Evidence-grounded review of broker-dealer retail recommendation obligations under Regulation Best Interest.
category: compliance
version: 0.1.0
tags:
- reg-bi
...
problems_solved:
- Assess Regulation Best Interest applicability and evidence.
...
deliverables:
- Regulation Best Interest recommendation review brief
commands: []
skills: []
evaluations:
- Regulation Best Interest source-awareness check
trust_tier: trusted
status: beta
license: CC-BY-4.0
related_bundles:
...
okb_bundle_id: regulation-best-interest
...
Use this bundle to prepare a reviewable **Regulation Best Interest recommendation review brief** without inventing local facts, configuration, evidence, results, permissions, or authority.
...
- [Regulation Best Interest recommendation review brief](deliverables/regulation-best-interest-brief.md)
