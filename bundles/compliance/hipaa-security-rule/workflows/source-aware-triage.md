---
type: Workflow
title: HIPAA Security Rule Source-Aware Triage
...
- Local evidence relevant to Security Rule.
- Missing documents, system records, transaction artifacts, contracts, policies, incident facts, or implementation guides.

## Steps

1. Classify the request as Security Rule work or route it back to the broader [HIPAA](../../hipaa/index.md) hub.
