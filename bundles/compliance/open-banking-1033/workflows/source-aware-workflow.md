---
type: Workflow
title: CFPB Personal Financial Data Rights (Section 1033) source-aware workflow
description: Verify-first workflow for producing a reviewable Section 1033 implementation-status brief.
---
...
7. Draft the Section 1033 implementation-status brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
