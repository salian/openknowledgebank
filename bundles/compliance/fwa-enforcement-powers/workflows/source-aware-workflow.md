---
type: Workflow
title: Fair Work Agency Enforcement Powers source-aware workflow
description: Verify-first workflow for producing a reviewable FWA enforcement-response readiness brief.
---
...
7. Draft the FWA enforcement-response readiness brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
