---
type: Workflow
title: SEC EDGAR Electronic Filing and Inline XBRL source-aware workflow
description: Verify-first workflow for producing a reviewable EDGAR filing readiness and validation brief.
---
...
7. Draft the EDGAR filing readiness and validation brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
