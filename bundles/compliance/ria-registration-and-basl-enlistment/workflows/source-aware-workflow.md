---
type: Workflow
title: SEBI Investment Adviser Registration and BASL Enlistment source-aware workflow
description: Verify-first workflow for producing a reviewable registration and enlistment readiness brief.
---
...
7. Draft the registration and enlistment readiness brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
