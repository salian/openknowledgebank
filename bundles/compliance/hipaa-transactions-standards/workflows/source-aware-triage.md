---
type: Workflow
title: HIPAA Transactions Standards Source-Aware Triage
...
- Local evidence relevant to Standard electronic transactions.
- Missing documents, system records, transaction artifacts, contracts, policies, incident facts, or implementation guides.

## Steps

1. Classify the request as Standard electronic transactions work or route it back to the broader [HIPAA](../../hipaa/index.md) hub.
