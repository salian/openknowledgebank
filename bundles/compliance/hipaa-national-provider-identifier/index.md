---
type: Bundle Index
title: HIPAA National Provider Identifier
description: Source-aware compliance bundle for NPI use, validation, and evidence handling in HIPAA standard transactions.
...
aliases:
  ...
  - NPPES NPI Registry
problems_solved:
  - Route National Provider Identifier Standard questions to the right official source category.
  - Separate official-source facts, user-provided evidence, assumptions, and missing verification.
  - Produce a NPI evidence and transaction-use brief suitable for qualified professional review.
...
skills: []
evaluations:
  - HIPAA National Provider Identifier source-awareness check
...
Source-aware compliance bundle for NPI use, validation, and evidence handling in HIPAA standard transactions.
