---
type: Workflow
title: HIPAA National Provider Identifier Source-Aware Triage
...
- Local evidence relevant to National Provider Identifier Standard.
- Missing documents, system records, transaction artifacts, contracts, policies, incident facts, or implementation guides.

## Steps

1. Classify the request as National Provider Identifier Standard work or route it back to the broader [HIPAA](../../hipaa/index.md) hub.
