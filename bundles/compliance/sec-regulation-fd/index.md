---
type: Bundle Index
title: SEC Regulation FD
description: Evidence-grounded review of selective disclosure controls under SEC Regulation FD.
category: compliance
version: 0.1.0
tags:
- sec
...
- Reg FD
problems_solved:
- Assess SEC Regulation FD applicability and evidence.
...
deliverables:
- Regulation FD disclosure-controls brief
commands: []
skills: []
evaluations:
- SEC Regulation FD source-awareness check
trust_tier: trusted
status: beta
license: CC-BY-4.0
related_bundles:
...
Use this bundle to prepare a reviewable **Regulation FD disclosure-controls brief** without inventing local facts, configuration, evidence, results, permissions, or authority.
...
- [Regulation FD disclosure-controls brief](deliverables/sec-regulation-fd-brief.md)
