---
type: Workflow
title: SEC Regulation FD source-aware workflow
description: Verify-first workflow for producing a reviewable Regulation FD disclosure-controls brief.
---
...
7. Draft the Regulation FD disclosure-controls brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
