---
type: Bundle Index
title: PCAOB Auditing Standards (AS Series)
description: Evidence-grounded guidance for PCAOB auditing-standard applicability and engagement compliance, with current-source, applicability, review, and authority controls.
category: compliance
version: 0.1.0
tags:
- pcaob
...
aliases:
- PCAOB AS series
- Public company auditing standards
problems_solved:
...
skills: []
evaluations:
- PCAOB Auditing Standards (AS Series) source-awareness check
trust_tier: trusted
status: beta
license: CC-BY-4.0
related_bundles:
...
okb_bundle_id: pcaob-auditing-standards
...
Use this bundle to prepare a reviewable **PCAOB Standards Applicability Brief** without inventing local facts, configuration, evidence, results, permissions, or authority.
...
- [PCAOB Standards Applicability Brief](deliverables/pcaob-auditing-standards-brief.md)
