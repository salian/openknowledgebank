---
type: Workflow
title: GDPR Transfer Impact Assessment and Supplementary Measures source-aware workflow
description: Verify-first workflow for producing a reviewable GDPR transfer impact assessment and supplementary-measures brief.
---
...
7. Draft the GDPR transfer impact assessment and supplementary-measures brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
8. Require explicit confirmation before make legal conclusions, certify compliance, file or amend a submission, issue a notice, alter controls, or represent approval.
