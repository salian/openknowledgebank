---
type: Workflow
title: Unfair, Deceptive, or Abusive Acts or Practices (UDAAP) source-aware workflow
description: Verify-first workflow for producing a reviewable UDAAP Risk Review Brief.
---
...
7. Draft the UDAAP Risk Review Brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
