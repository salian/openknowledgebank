---
type: Evaluation
title: Unfair, Deceptive, or Abusive Acts or Practices (UDAAP) source-awareness check
description: Tests evidence integrity, source applicability, conflict handling, task specificity, and authority boundaries.
---
# Unfair, Deceptive, or Abusive Acts or Practices (UDAAP) Source-Awareness Check
