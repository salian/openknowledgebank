---
type: Bundle Index
title: State Blue Sky Securities Regulation
description: Jurisdiction-aware review of state securities offering registration, exemption, notice, and fee requirements.
category: compliance
version: 0.1.0
tags:
- blue-sky
...
aliases:
- Blue sky laws
- State securities offering rules
problems_solved:
- Assess State Blue Sky Securities Regulation applicability and evidence.
...
deliverables:
- state blue sky offering requirements matrix
commands: []
skills: []
evaluations:
- State Blue Sky Securities Regulation source-awareness check
trust_tier: trusted
status: beta
license: CC-BY-4.0
related_bundles:
...
okb_bundle_id: state-blue-sky-securities-regulation
...
Use this bundle to prepare a reviewable **state blue sky offering requirements matrix** without inventing local facts, configuration, evidence, results, permissions, or authority.
...
- [state blue sky offering requirements matrix](deliverables/state-blue-sky-securities-regulation-brief.md)
