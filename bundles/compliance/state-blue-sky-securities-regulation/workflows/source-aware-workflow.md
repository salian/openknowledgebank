---
type: Workflow
title: State Blue Sky Securities Regulation source-aware workflow
description: Verify-first workflow for producing a reviewable state blue sky offering requirements matrix.
---
...
7. Draft the state blue sky offering requirements matrix, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
