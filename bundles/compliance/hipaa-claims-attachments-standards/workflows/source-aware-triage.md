---
type: Workflow
title: HIPAA Claims Attachments Standards Source-Aware Triage
...
- Local evidence relevant to Administrative Simplification claims attachments standards.
- Missing documents, system records, transaction artifacts, contracts, policies, incident facts, or implementation guides.

## Steps

1. Classify the request as Administrative Simplification claims attachments standards work or route it back to the broader [HIPAA](../../hipaa/index.md) hub.
