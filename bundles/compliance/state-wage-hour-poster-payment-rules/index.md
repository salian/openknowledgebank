---
type: Bundle Index
title: State Wage, Hour, Poster, and Payment Rules
description: Jurisdiction-aware review of state wage-and-hour, workplace-poster, payday, deduction, and final-pay rules.
category: compliance
version: 0.1.0
tags:
- wage-hour
...
- State labor posters and payday rules
problems_solved:
- Assess State Wage, Hour, Poster, and Payment Rules applicability and evidence.
...
deliverables:
- state wage, hour, poster, and payment requirements matrix
commands: []
skills: []
evaluations:
- State Wage, Hour, Poster, and Payment Rules source-awareness check
trust_tier: trusted
status: beta
license: CC-BY-4.0
related_bundles:
...
okb_bundle_id: state-wage-hour-poster-payment-rules
...
---
# State Wage, Hour, Poster, and Payment Rules

Use this bundle to prepare a reviewable **state wage, hour, poster, and payment requirements matrix** without inventing local facts, configuration, evidence, results, permissions, or authority.
...
- [state wage, hour, poster, and payment requirements matrix](deliverables/state-wage-hour-poster-payment-rules-brief.md)
