---
type: Workflow
title: State Wage, Hour, Poster, and Payment Rules source-aware workflow
description: Verify-first workflow for producing a reviewable state wage, hour, poster, and payment requirements matrix.
---
...
7. Draft the state wage, hour, poster, and payment requirements matrix, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
