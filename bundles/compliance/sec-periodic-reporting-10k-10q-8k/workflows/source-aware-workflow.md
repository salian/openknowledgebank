---
type: Workflow
title: SEC Exchange Act Periodic Reporting (10-K, 10-Q, 8-K) source-aware workflow
description: Verify-first workflow for producing a reviewable periodic-reporting calendar and readiness brief.
---
...
7. Draft the periodic-reporting calendar and readiness brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
