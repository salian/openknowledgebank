---
type: Workflow
title: SCORM source-aware workflow
description: Verify-first workflow for producing a reviewable SCORM conformance and interoperability brief.
---
...
7. Draft the SCORM conformance and interoperability brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
