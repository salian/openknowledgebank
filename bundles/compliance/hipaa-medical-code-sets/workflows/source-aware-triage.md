---
type: Workflow
title: HIPAA Medical Code Sets Source-Aware Triage
...
- Local evidence relevant to HIPAA adopted medical code sets.
- Missing documents, system records, transaction artifacts, contracts, policies, incident facts, or implementation guides.

## Steps

1. Classify the request as HIPAA adopted medical code sets work or route it back to the broader [HIPAA](../../hipaa/index.md) hub.
