---
type: Workflow
title: HIPAA Enforcement Cooperation Source-Aware Triage
...
- Local evidence relevant to HIPAA Enforcement Rule and OCR cooperation.
- Missing documents, system records, transaction artifacts, contracts, policies, incident facts, or implementation guides.

## Steps

1. Classify the request as HIPAA Enforcement Rule and OCR cooperation work or route it back to the broader [HIPAA](../../hipaa/index.md) hub.
