---
type: Bundle Index
title: State Securities Registration, Renewal, and Examinations
description: Jurisdiction-aware review of state securities registration, renewal, and examination requirements for firms and individuals.
category: compliance
version: 0.1.0
tags:
- state-securities
...
- CRD and IARD registration
problems_solved:
- Assess State Securities Registration, Renewal, and Examinations applicability and evidence.
...
deliverables:
- state securities registration and renewal matrix
commands: []
skills: []
evaluations:
- State Securities Registration, Renewal, and Examinations source-awareness check
trust_tier: trusted
status: beta
license: CC-BY-4.0
related_bundles:
...
okb_bundle_id: state-registration-renewal-and-exams
...
---
# State Securities Registration, Renewal, and Examinations

Use this bundle to prepare a reviewable **state securities registration and renewal matrix** without inventing local facts, configuration, evidence, results, permissions, or authority.
...
- [state securities registration and renewal matrix](deliverables/state-registration-renewal-and-exams-brief.md)
