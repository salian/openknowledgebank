---
type: Workflow
title: State Securities Registration, Renewal, and Examinations source-aware workflow
description: Verify-first workflow for producing a reviewable state securities registration and renewal matrix.
---
...
7. Draft the state securities registration and renewal matrix, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
