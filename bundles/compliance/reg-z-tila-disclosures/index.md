---
type: Bundle Index
title: Regulation Z TILA Disclosures
description: Evidence-grounded review of Truth in Lending Act disclosures and controls under Regulation Z.
category: compliance
version: 0.1.0
tags:
- regulation-z
...
- TILA disclosures
problems_solved:
- Assess Regulation Z TILA Disclosures applicability and evidence.
...
deliverables:
- Regulation Z disclosure and calculation review brief
commands: []
skills: []
evaluations:
- Regulation Z TILA Disclosures source-awareness check
trust_tier: trusted
status: beta
license: CC-BY-4.0
related_bundles:
...
okb_bundle_id: reg-z-tila-disclosures
...
---
# Regulation Z TILA Disclosures

Use this bundle to prepare a reviewable **Regulation Z disclosure and calculation review brief** without inventing local facts, configuration, evidence, results, permissions, or authority.
...
- [Regulation Z disclosure and calculation review brief](deliverables/reg-z-tila-disclosures-brief.md)
