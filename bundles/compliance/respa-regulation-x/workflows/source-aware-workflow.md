---
type: Workflow
title: RESPA Regulation X source-aware workflow
description: Verify-first workflow for producing a reviewable RESPA Regulation X applicability and controls brief.
---
...
7. Draft the RESPA Regulation X applicability and controls brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
