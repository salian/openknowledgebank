---
type: Bundle Index
title: RESPA Regulation X
description: Evidence-grounded review of Real Estate Settlement Procedures Act requirements implemented by Regulation X.
category: compliance
version: 0.1.0
tags:
- respa
...
- RESPA
problems_solved:
- Assess RESPA Regulation X applicability and evidence.
...
deliverables:
- RESPA Regulation X applicability and controls brief
commands: []
skills: []
evaluations:
- RESPA Regulation X source-awareness check
trust_tier: trusted
status: beta
license: CC-BY-4.0
related_bundles:
...
okb_bundle_id: respa-regulation-x
...
Use this bundle to prepare a reviewable **RESPA Regulation X applicability and controls brief** without inventing local facts, configuration, evidence, results, permissions, or authority.
...
- [RESPA Regulation X applicability and controls brief](deliverables/respa-regulation-x-brief.md)
