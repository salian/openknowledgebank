...
description: Jurisdiction-aware review of workers compensation coverage, registration, insurance, self-insurance, posting, and reporting duties.
category: compliance
version: 0.1.0
tags:
...
problems_solved:
- Assess Workers Compensation Coverage applicability and evidence.
...
deliverables:
- workers compensation coverage and obligations matrix
commands: []
skills: []
evaluations:
- Workers Compensation Coverage source-awareness check
trust_tier: trusted
status: beta
license: CC-BY-4.0
related_bundles:
...
okb_bundle_id: workers-compensation-coverage
...
Use this bundle to prepare a reviewable **workers compensation coverage and obligations matrix** without inventing local facts, configuration, evidence, results, permissions, or authority.
...
- [workers compensation coverage and obligations matrix](deliverables/workers-compensation-coverage-brief.md)
