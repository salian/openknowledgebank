---
type: Workflow
title: Workers Compensation Coverage source-aware workflow
description: Verify-first workflow for producing a reviewable workers compensation coverage and obligations matrix.
---
...
7. Draft the workers compensation coverage and obligations matrix, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
