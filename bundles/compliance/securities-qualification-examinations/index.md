---
type: Bundle Index
title: Securities Qualification Examinations
description: Evidence-grounded planning and review of FINRA securities qualification examination requirements.
category: compliance
version: 0.1.0
tags:
- finra
...
- Securities exams
problems_solved:
- Assess Securities Qualification Examinations applicability and evidence.
...
deliverables:
- securities qualification examination pathway brief
commands: []
skills: []
evaluations:
- Securities Qualification Examinations source-awareness check
trust_tier: trusted
status: beta
license: CC-BY-4.0
related_bundles:
...
okb_bundle_id: securities-qualification-examinations
...
---
# Securities Qualification Examinations

Use this bundle to prepare a reviewable **securities qualification examination pathway brief** without inventing local facts, configuration, evidence, results, permissions, or authority.
...
- [securities qualification examination pathway brief](deliverables/securities-qualification-examinations-brief.md)
