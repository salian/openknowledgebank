---
type: Workflow
title: Real Estate Licensure source-aware workflow
description: Verify-first workflow for producing a reviewable jurisdiction-specific real estate licensure matrix.
---
...
3. Inventory jurisdiction, role and activity, entity structure, regulator materials, education and examination records, application and renewal status, sponsorship, disclosures, discipline, and approvals.
...
7. Draft the jurisdiction-specific real estate licensure matrix, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
