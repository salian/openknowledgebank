---
type: Workflow
title: LGPD Security Incident Communication source-aware workflow
description: Verify-first workflow for producing a reviewable LGPD security-incident assessment and communication brief.
---
...
7. Draft the LGPD security-incident assessment and communication brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
