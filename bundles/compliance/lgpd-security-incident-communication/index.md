---
type: Bundle Index
title: LGPD Security Incident Communication
description: Evidence-grounded assessment and communication planning for personal-data security incidents under Brazil's LGPD and ANPD Resolution 15/2024.
category: compliance
version: 0.1.0
tags:
- lgpd
...
- anpd
aliases:
- ANPD incident communication
- LGPD breach notification
problems_solved:
- Assess LGPD Security Incident Communication applicability and evidence.
...
deliverables:
- LGPD security-incident assessment and communication brief
commands: []
skills: []
evaluations:
- LGPD Security Incident Communication source-awareness check
trust_tier: trusted
status: beta
license: CC-BY-4.0
related_bundles:
...
okb_bundle_id: lgpd-security-incident-communication
...
---
# LGPD Security Incident Communication

Use this bundle to prepare a reviewable **LGPD security-incident assessment and communication brief** without inventing local facts, configuration, evidence, results, permissions, or authority.
...
- [LGPD security-incident assessment and communication brief](deliverables/lgpd-security-incident-communication-brief.md)
