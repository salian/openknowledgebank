---
type: Bundle Index
title: State Pay Transparency
description: Jurisdiction-aware review of state and local pay-transparency and pay-scale disclosure requirements.
category: compliance
version: 0.1.0
tags:
- pay-transparency
...
problems_solved:
- Assess State Pay Transparency applicability and evidence.
...
deliverables:
- state and local pay-transparency requirements matrix
commands: []
skills: []
evaluations:
- State Pay Transparency source-awareness check
trust_tier: trusted
status: beta
license: CC-BY-4.0
related_bundles:
...
okb_bundle_id: state-pay-transparency
...
Use this bundle to prepare a reviewable **state and local pay-transparency requirements matrix** without inventing local facts, configuration, evidence, results, permissions, or authority.
...
- [state and local pay-transparency requirements matrix](deliverables/state-pay-transparency-brief.md)
