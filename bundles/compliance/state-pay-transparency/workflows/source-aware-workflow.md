---
type: Workflow
title: State Pay Transparency source-aware workflow
description: Verify-first workflow for producing a reviewable state and local pay-transparency requirements matrix.
---
...
7. Draft the state and local pay-transparency requirements matrix, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
