---
type: Workflow
title: Employer Employment Tax and Wage Reporting source-aware workflow
description: Verify-first workflow for producing a reviewable employment-tax return reconciliation brief.
---
...
7. Draft the employment-tax return reconciliation brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
