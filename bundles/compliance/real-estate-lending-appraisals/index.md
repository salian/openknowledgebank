---
type: Bundle Index
title: Real Estate Lending Appraisals
description: Evidence-grounded review of federal appraisal requirements and institution-specific real estate lending controls.
category: compliance
version: 0.1.0
tags:
- real-estate-lending
...
problems_solved:
- Assess Real Estate Lending Appraisals applicability and evidence.
...
deliverables:
- real estate appraisal requirements and evidence brief
commands: []
skills: []
evaluations:
- Real Estate Lending Appraisals source-awareness check
trust_tier: trusted
status: beta
license: CC-BY-4.0
related_bundles:
...
okb_bundle_id: real-estate-lending-appraisals
...
Use this bundle to prepare a reviewable **real estate appraisal requirements and evidence brief** without inventing local facts, configuration, evidence, results, permissions, or authority.
...
- [real estate appraisal requirements and evidence brief](deliverables/real-estate-lending-appraisals-brief.md)
