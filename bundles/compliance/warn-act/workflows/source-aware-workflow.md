---
type: Workflow
title: Worker Adjustment and Retraining Notification Act source-aware workflow
description: Verify-first workflow for producing a reviewable WARN Act coverage and notice review brief.
---
...
7. Draft the WARN Act coverage and notice review brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
