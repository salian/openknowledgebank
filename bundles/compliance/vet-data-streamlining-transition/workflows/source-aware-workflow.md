---
type: Workflow
title: VET Information Standard Transition source-aware workflow
description: Verify-first workflow for producing a reviewable VET data transition readiness brief.
---
...
7. Draft the VET data transition readiness brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
