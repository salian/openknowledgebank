---
type: Workflow
title: Total Loss-Absorbing Capacity and Long-Term Debt source-aware workflow
description: Verify-first workflow for producing a reviewable TLAC and long-term-debt applicability and calculation brief.
---
...
7. Draft the TLAC and long-term-debt applicability and calculation brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
