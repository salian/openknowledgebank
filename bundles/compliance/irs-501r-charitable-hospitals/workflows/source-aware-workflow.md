---
type: Workflow
title: IRC Section 501(r) Charitable Hospital Requirements source-aware workflow
description: Verify-first workflow for producing a reviewable Section 501(r) hospital compliance brief.
---
...
7. Draft the Section 501(r) hospital compliance brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
