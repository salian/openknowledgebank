---
type: Workflow
title: LGPD Records of Processing Activities (RoPA) source-aware workflow
description: Verify-first workflow for producing a reviewable LGPD processing-operations register review brief.
---
...
7. Draft the LGPD processing-operations register review brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
