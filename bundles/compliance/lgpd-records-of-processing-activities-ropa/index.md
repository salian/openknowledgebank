---
type: Bundle Index
title: LGPD Records of Processing Activities (RoPA)
description: Evidence-grounded preparation and review of processing records under Brazil's LGPD.
category: compliance
version: 0.1.0
tags:
- lgpd
...
problems_solved:
- Assess LGPD Records of Processing Activities (RoPA) applicability and evidence.
...
deliverables:
- LGPD processing-operations register review brief
commands: []
skills: []
evaluations:
- LGPD Records of Processing Activities (RoPA) source-awareness check
trust_tier: trusted
status: beta
license: CC-BY-4.0
related_bundles:
...
okb_bundle_id: lgpd-records-of-processing-activities-ropa
...
---
# LGPD Records of Processing Activities (RoPA)

Use this bundle to prepare a reviewable **LGPD processing-operations register review brief** without inventing local facts, configuration, evidence, results, permissions, or authority.
...
- [LGPD processing-operations register review brief](deliverables/lgpd-records-of-processing-activities-ropa-brief.md)
