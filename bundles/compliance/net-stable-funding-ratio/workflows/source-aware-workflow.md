---
type: Workflow
title: Net Stable Funding Ratio (NSFR) Rule source-aware workflow
description: Verify-first workflow for producing a reviewable NSFR Calculation and Shortfall Review Brief.
---
...
7. Draft the NSFR Calculation and Shortfall Review Brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
