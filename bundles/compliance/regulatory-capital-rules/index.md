...
description: Evidence-grounded review of U.S. banking regulatory capital applicability, calculations, reporting, and governance.
category: compliance
version: 0.1.0
tags:
- regulatory-capital
...
- Basel capital implementation
problems_solved:
- Assess Regulatory Capital Rules applicability and evidence.
...
deliverables:
- regulatory capital applicability and calculation review brief
commands: []
skills: []
evaluations:
- Regulatory Capital Rules source-awareness check
trust_tier: trusted
status: beta
license: CC-BY-4.0
related_bundles:
...
okb_bundle_id: regulatory-capital-rules
...
Use this bundle to prepare a reviewable **regulatory capital applicability and calculation review brief** without inventing local facts, configuration, evidence, results, permissions, or authority.
...
- [regulatory capital applicability and calculation review brief](deliverables/regulatory-capital-rules-brief.md)
