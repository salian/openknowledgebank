---
type: Workflow
title: Federal Reserve Supervisory Stress Testing (DFAST / CCAR) source-aware workflow
description: Verify-first workflow for producing a reviewable stress-testing applicability and governance brief.
---
...
7. Draft the stress-testing applicability and governance brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
