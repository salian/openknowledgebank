---
type: Workflow
title: Multistate Comprehensive Privacy Law Common Provisions source-aware workflow
description: Verify-first workflow for producing a reviewable state privacy comparison and routing matrix.
---
...
7. Draft the state privacy comparison and routing matrix, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
