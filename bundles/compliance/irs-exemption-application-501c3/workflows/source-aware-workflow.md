---
type: Workflow
title: IRS Exemption Application: Form 1023 or 1023-EZ source-aware workflow
description: Verify-first workflow for producing a reviewable 501(c)(3) application readiness brief.
---
...
7. Draft the 501(c)(3) application readiness brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
