---
type: Evaluation
title: Registration as a Registered Training Organisation (RTO) source-awareness check
description: Tests evidence integrity, source applicability, conflict handling, task specificity, and authority boundaries.
---
# Registration as a Registered Training Organisation (RTO) Source-Awareness Check
