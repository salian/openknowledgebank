---
type: Workflow
title: Registration as a Registered Training Organisation (RTO) source-aware workflow
description: Verify-first workflow for producing a reviewable Registration as a Registered Training Organisation (RTO) source-aware brief.
---
...
7. Draft the Registration as a Registered Training Organisation (RTO) source-aware brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
