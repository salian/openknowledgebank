---
type: Workflow
title: HIPAA Security Rule Cybersecurity NPRM Source-Aware Triage
...
- Local evidence relevant to Security Rule cybersecurity NPRM.
- Missing documents, system records, transaction artifacts, contracts, policies, incident facts, or implementation guides.

## Steps

1. Classify the request as Security Rule cybersecurity NPRM work or route it back to the broader [HIPAA](../../hipaa/index.md) hub.
