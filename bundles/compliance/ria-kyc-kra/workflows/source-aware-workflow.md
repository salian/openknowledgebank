---
type: Workflow
title: Client KYC and Upload to KYC Registration Agency (KRA) source-aware workflow
description: Verify-first workflow for producing a reviewable Client KYC and Upload to KYC Registration Agency (KRA) source-aware brief.
---
...
7. Draft the Client KYC and Upload to KYC Registration Agency (KRA) source-aware brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
