---
type: Workflow
title: LGPD Article 18 Data-Subject Rights source-aware workflow
description: Verify-first workflow for producing a reviewable LGPD rights-request response brief.
---
...
7. Draft the LGPD rights-request response brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
