---
type: Workflow
title: OCC Lending Limits source-aware workflow
description: Verify-first workflow for producing a reviewable lending-limit aggregation and approval brief.
---
...
7. Draft the lending-limit aggregation and approval brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
