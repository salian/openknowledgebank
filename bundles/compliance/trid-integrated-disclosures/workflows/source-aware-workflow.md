---
type: Workflow
title: TILA-RESPA Integrated Disclosures (TRID) source-aware workflow
description: Verify-first workflow for producing a reviewable TRID Loan Estimate and Closing Disclosure review brief.
---
...
7. Draft the TRID Loan Estimate and Closing Disclosure review brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
