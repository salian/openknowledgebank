---
type: Workflow
title: HMRC VAT Registration, Returns, and Making Tax Digital source-aware workflow
description: Verify-first workflow for producing a reviewable UK VAT registration, return, and MTD review brief.
---
...
7. Draft the UK VAT registration, return, and MTD review brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
