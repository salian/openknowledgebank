---
type: Evaluation
title: Technical and Administrative Security Measures — Arts. 46-49 LGPD source-awareness check
description: Tests evidence integrity, source applicability, conflict handling, task specificity, and authority boundaries.
---
# Technical and Administrative Security Measures — Arts. 46-49 LGPD Source-Awareness Check
