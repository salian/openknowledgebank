---
type: Workflow
title: Quebec Private-Sector Privacy Act (Law 25) source-aware workflow
description: Verify-first workflow for producing a reviewable Quebec privacy compliance brief.
---
...
7. Draft the Quebec privacy compliance brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
