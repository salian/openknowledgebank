---
type: Workflow
title: OCC Heightened Standards for Large Banks source-aware workflow
description: Verify-first workflow for producing a reviewable heightened-standards applicability and governance brief.
---
...
7. Draft the heightened-standards applicability and governance brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
