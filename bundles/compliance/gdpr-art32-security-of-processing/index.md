...
description: Evidence-grounded review of risk-appropriate technical and organizational security measures under GDPR Article 32.
category: compliance
version: 0.1.0
tags:
- gdpr
...
- Article 32
problems_solved:
- Assess GDPR Article 32 Security of Processing applicability and evidence.
...
skills: []
evaluations:
- GDPR Article 32 Security of Processing source-awareness check
trust_tier: trusted
status: beta
license: CC-BY-4.0
related_bundles:
...
okb_bundle_id: gdpr-art32-security-of-processing
...
Use this bundle to prepare a reviewable **GDPR Article 32 security-of-processing review brief** without inventing local facts, configuration, evidence, results, permissions, or authority.
...
- [GDPR Article 32 security-of-processing review brief](deliverables/gdpr-art32-security-of-processing-brief.md)
