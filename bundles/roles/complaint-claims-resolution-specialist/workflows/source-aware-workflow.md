---
type: Workflow
title: Complaint and Claims Resolution Specialist source-aware workflow
description: Verify-first workflow for producing a reviewable complaint or claim investigation and resolution brief.
---
...
7. Draft the complaint or claim investigation and resolution brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
8. Require explicit confirmation before admit liability, accept or deny a claim, offer compensation or settlement, change a customer record, contact a regulator or third party, disclose protected information, or represent final resolution.
