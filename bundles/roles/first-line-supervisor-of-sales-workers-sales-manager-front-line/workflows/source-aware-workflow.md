---
type: Workflow
title: First-Line Supervisor of Sales Workers source-aware workflow
description: Verify-first workflow for producing a reviewable sales supervision decision brief.
---
...
3. Inventory role charter, schedule, attendance, goals, sales, returns, discounts, customer interactions, quality, complaints, inventory, policy, training, coaching, accommodations, performance, and approvals.
...
7. Draft the sales supervision decision brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
8. Require explicit confirmation before change schedules, approve discounts or refunds, contact customers, access personal data, issue discipline, change pay or goals, make employment decisions, or claim performance outcomes.
