---
type: Workflow
title: Design Manager / Head of Design Source-Aware Triage
---

# Source-Aware Triage

1. State the requested decision or deliverable.
2. Inventory evidence: product and user outcomes, research and usability evidence, design-system state, technical constraints, accessibility evaluation, content and asset rights, timeline, staffing, and approval.
...
5. Produce the smallest reviewable Design direction and review brief.
