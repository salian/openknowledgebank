---
type: Workflow
title: Accessibility Specialist source-aware triage
---
# Source-Aware Triage

1. State the requested decision or artifact.
2. Inventory evidence: users and platforms; WCAG version, level, and criterion-level tests; code, design, browser, assistive-technology, and test-tool versions; manual and automated findings with severity and reproduction steps; exceptions, remediation, retest evidence, and approvals.
...
5. Produce the smallest reviewable accessibility assessment brief.
