---
type: Workflow
title: Chief Sustainability Officer source-aware workflow
description: Verify-first workflow for producing a reviewable sustainability strategy and governance decision brief.
---
...
7. Draft the sustainability strategy and governance decision brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
8. Require explicit confirmation before approve targets or disclosures, certify environmental or social claims, commit capital, direct operations, make personnel decisions, or represent executive or board approval.
