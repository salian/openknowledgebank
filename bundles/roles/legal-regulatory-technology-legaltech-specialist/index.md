---
type: Bundle Index
title: Legal / Regulatory Technology (Legaltech) Specialist
description: Evidence-grounded guidance for legal and regulatory technology requirements, data, workflows, controls, testing, and adoption.
schema_version: 0.1.0
bundle_format: okf-compatible
category: roles
tags: [legaltech, regtech, legal-technology]
aliases: [Legaltech Specialist, Regulatory Technology Specialist, Regtech Specialist]
...
okb_bundle_id: legal-regulatory-technology-legaltech-specialist
okb_bundle_version: 0.1.0
trust_tier: trusted
status: beta
license: CC-BY-4.0
related_bundles: [legal-operations-manager, paralegal-legal-assistant, legal-counsel-corporate-counsel-in-house]
adjacent_bundles: [compliance-officer, security-assessment-report, architecture-design-doc]
contributors: [OpenKnowledgeBank]
maintainers: [OpenKnowledgeBank]
standard_mappings: {onet_soc: [23-2011.00], soc: [23-2011], isco_08: [3411], esco: []}
content_risk:
  classification: ymyl
  domains: [legal, privacy, security, financial]
  professional_review:
    status: not_reviewed
    required_qualification: A licensed lawyer and qualified legal-technology, regulatory, privacy, security, records, procurement, or domain professional appropriate to the system and jurisdiction.
limitations:
...
# Legal / Regulatory Technology (Legaltech) Specialist

Use the [overview](overview.md), [role guide](role.md), [workflow](workflow.md), and [quality check](evaluations/quality-check.md). No use case, client and matter scope, legal requirements, privilege, confidentiality, data classification, retention, access, architecture, vendor, model or rule behavior, tests, exceptions, and audit trail fact is assumed.
