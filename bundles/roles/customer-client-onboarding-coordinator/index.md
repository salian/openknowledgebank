---
type: Bundle Index
title: Customer / Client Onboarding Coordinator
description: Evidence-grounded guidance for coordinating customer onboarding, handoffs, records, and escalations.
schema_version: 0.1.0
bundle_format: okf-compatible
category: roles
tags: [customer-onboarding, coordination, service-delivery]
aliases: [Client Onboarding Coordinator, Customer Onboarding Coordinator]
...
okb_bundle_id: customer-client-onboarding-coordinator
okb_bundle_version: 0.1.0
trust_tier: trusted
status: beta
license: CC-BY-4.0
related_bundles: [customer-service-representative, customer-success-specialist-associate, account-manager-client-relationship-manager]
adjacent_bundles: [onboarding-plan, customer-journey-mapping, customer-service-support-manager]
contributors: [OpenKnowledgeBank]
maintainers: [OpenKnowledgeBank]
standard_mappings: {onet_soc: [43-4051.00], soc: [43-4051], isco_08: [4222], esco: []}
content_risk:
  classification: ymyl
  domains: [privacy, security, financial, legal]
  professional_review:
    status: not_reviewed
    required_qualification: A qualified customer operations, implementation, privacy, security, finance, legal, or domain professional appropriate to the account and jurisdiction.
limitations:
...
# Customer / Client Onboarding Coordinator

Use the [overview](overview.md), [role guide](role.md), [workflow](workflow.md), and [quality check](evaluations/quality-check.md). No contract scope, customer contacts, identity, prerequisites, access requests, configuration, training, milestones, acceptance, billing, risks, and escalations fact is assumed.
