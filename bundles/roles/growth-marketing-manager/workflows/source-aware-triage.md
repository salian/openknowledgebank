---
type: Workflow
title: Growth Marketing Manager Source-Aware Triage
---

# Source-Aware Triage

1. State the requested decision or deliverable.
2. Inventory evidence: business objective, funnel and metric definitions, identity and attribution rules, channel and campaign exports, experiment design and guardrails, budget authority, consent and suppression rules.
3. Label every item as verified, provided, assumed, or needs verification.
4. Reconcile conflicting definitions, dates, scopes, states, and owners.
5. Produce the smallest reviewable Growth strategy and experiment decision brief.
