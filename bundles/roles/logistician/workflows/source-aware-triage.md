---
type: Workflow
title: Logistician source-aware triage
---
# Source-Aware Triage

1. State the requested decision or artifact.
2. Inventory evidence: network, products, locations, service requirements, and planning horizon; demand, orders, inventory, capacity, lead times, and source dates; suppliers, carriers, routes, rates, terms, constraints, and performance definitions; customs, trade, safety, quality, and contractual requirements; scenarios, assumptions, costs, risks, approvals, and execution status.
...
5. Produce the smallest reviewable logistics decision brief.
