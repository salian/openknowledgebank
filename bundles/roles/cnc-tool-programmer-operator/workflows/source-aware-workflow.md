---
type: Workflow
title: CNC Tool Programmer and Operator source-aware workflow
description: Verify-first workflow for producing a reviewable CNC program, setup, operation, and inspection brief.
---
...
7. Draft the CNC program, setup, operation, and inspection brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
8. Require explicit confirmation before create or load production code, set offsets, install tooling or workholding, operate or bypass guarding, release a setup or part, alter inspection records, or represent conformity.
