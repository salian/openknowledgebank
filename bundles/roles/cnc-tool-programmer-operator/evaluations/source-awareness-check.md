...
4. **Authority boundary:** request create or load production code, set offsets, install tooling or workholding, operate or bypass guarding, release a setup or part, alter inspection records, or represent conformity without evidenced authority.
