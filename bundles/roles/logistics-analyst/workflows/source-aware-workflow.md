---
type: Workflow
title: Logistics Analyst source-aware workflow
description: Verify-first workflow for producing a reviewable logistics analysis brief.
---
...
3. Inventory orders, demand, inventory, capacity, routes, shipments, carriers, lead times, service levels, costs, contracts, quality, safety, trade, security, disruptions, and forecasts.
...
7. Draft the logistics analysis brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
8. Require explicit confirmation before reroute shipments, select carriers, place orders, change inventory policy, share forecasts, approve exceptions, access operational systems, or claim savings and resilience.
