---
type: Workflow
title: Automotive Service Technician and Mechanic source-aware workflow
description: Verify-first workflow for producing a reviewable automotive diagnostic and service-work brief.
---
...
7. Draft the automotive diagnostic and service-work brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
8. Require explicit confirmation before operate or move a vehicle, perform diagnosis or repair, disable safety or emissions controls, order parts, charge a customer, release a vehicle, or represent roadworthiness.
