---
type: Workflow
title: Budget Analyst source-aware triage
---
# Source-Aware Triage

1. State the requested decision or artifact.
2. Inventory evidence: entity, program, period, appropriation, and funding authority; actuals, commitments, allocations, and source-system extracts; forecast assumptions and scenarios; variance definitions and calculations; request documentation and approvals.
...
5. Produce the smallest reviewable budget analysis brief.
