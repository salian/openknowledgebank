---
type: Workflow
title: Regulatory Affairs Manager source-aware triage
---
# Source-Aware Triage

1. State the requested decision or artifact.
2. Inventory evidence: product, intended use, jurisdiction, classification, and lifecycle stage; current rules, guidance, effective dates, claims, and strategy; dossier and source-record provenance; submission version and history; commitments, regulator correspondence, quality, legal, and accountable review.
...
5. Produce the smallest reviewable regulatory strategy brief.
