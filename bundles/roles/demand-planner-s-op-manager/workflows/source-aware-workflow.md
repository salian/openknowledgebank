---
type: Workflow
title: Demand Planner and S&OP Manager source-aware workflow
description: Verify-first workflow for producing a reviewable demand plan and S&OP decision brief.
---
...
7. Draft the demand plan and S&OP decision brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
8. Require explicit confirmation before publish an approved forecast, commit supply or inventory, override planning data, change commercial or financial targets, direct functions, or represent consensus or executive approval.
