---
type: Workflow
title: Cargo and Freight Agent source-aware workflow
description: Verify-first workflow for producing a reviewable cargo shipment coordination and exception brief.
---
...
7. Draft the cargo shipment coordination and exception brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
8. Require explicit confirmation before book or release cargo, issue or alter transport documents, classify goods, make customs declarations, handle dangerous goods, approve charges, or represent carrier or customer authority.
