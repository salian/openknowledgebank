---
type: Workflow
title: Social Media Manager / Specialist Source-Aware Triage
---

# Source-Aware Triage

1. State the requested decision or deliverable.
2. Inventory evidence: audience and channel brief, approved claims and brand voice, content rights and releases, platform and moderation policy, content calendar, dated performance export, publishing approvals.
...
5. Produce the smallest reviewable Social media content and community brief.
