...
description: Evidence-grounded guidance for customer advocacy programs, references, reviews, stories, consent, and truthful representation.
schema_version: 0.1.0
bundle_format: okf-compatible
category: roles
tags: [customer-advocacy, customer-marketing, testimonials]
aliases: [Customer Advocate Manager, Customer Marketing Advocacy Manager]
...
okb_bundle_id: customer-advocacy-manager
okb_bundle_version: 0.1.0
trust_tier: trusted
status: beta
license: CC-BY-4.0
related_bundles: [customer-experience-cx-manager, community-manager-customer-support-community, chief-marketing-officer-cmo]
adjacent_bundles: [customer-journey-mapping, content-marketing-manager-content-strategist, digital-marketing-manager]
contributors: [OpenKnowledgeBank]
maintainers: [OpenKnowledgeBank]
standard_mappings: {onet_soc: [11-2032.00], soc: [11-2032], isco_08: [1222], esco: []}
content_risk:
  classification: regulated
  domains: [legal, privacy, financial]
  professional_review:
    status: not_reviewed
    required_qualification: A qualified customer-marketing, consumer-protection, privacy, legal, brand, accessibility, or domain professional appropriate to the claim and jurisdiction.
limitations:
...
Use the [overview](overview.md), [role guide](role.md), [workflow](workflow.md), and [quality check](evaluations/quality-check.md). No customer identity, relationship, consent, permissions, exact experience, claim substantiation, typicality, material connections, disclosures, assets, channels, review history, and withdrawal fact is assumed.
