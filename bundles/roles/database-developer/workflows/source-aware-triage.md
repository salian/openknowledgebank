---
type: Workflow
title: Database Developer source-aware triage
---
# Source-Aware Triage

1. State the requested decision or artifact.
2. Inventory evidence: requirements, database engine and version; schema, DDL, data contracts, grain, keys, routines, queries, and indexes; migration and backfill plan; permissions, security, test data, performance results, deployment, rollback, and approvals.
