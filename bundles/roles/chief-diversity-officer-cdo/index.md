...
description: Evidence-grounded guidance for inclusion strategy, workforce evidence, governance, and review without unsupported demographic or legal conclusions.
schema_version: 0.1.0
bundle_format: okf-compatible
category: roles
tags: [diversity, inclusion, employment-governance]
aliases: [CDO, Chief Diversity Executive]
...
okb_bundle_id: chief-diversity-officer-cdo
okb_bundle_version: 0.1.0
trust_tier: trusted
status: beta
license: CC-BY-4.0
related_bundles: [chief-human-resources-officer-chro, human-resources-manager, equal-opportunity-fair-access-compliance-representative]
adjacent_bundles: [eeoc-anti-discrimination-compliance, eeo-workforce-reporting, employee-handbook-policies]
...
content_risk:
  ...
  professional_review:
    status: not_reviewed
    required_qualification: A qualified employment, equal-opportunity, privacy, workforce-analytics, labor-relations, accessibility, or legal professional appropriate to the workforce and jurisdiction.
limitations:
...
Use the [overview](overview.md), [role guide](role.md), [workflow](workflow.md), and [quality check](evaluations/quality-check.md). No workforce definitions, demographic data provenance, consent or legal basis, access, representation, hiring, pay, promotion, attrition, experience, accommodation, complaints, interventions, and outcomes fact is assumed.
