...
description: Evidence-grounded guidance for revenue strategy, commercial coordination, forecasting, and governed growth decisions.
schema_version: 0.1.0
bundle_format: okf-compatible
category: roles
tags: [revenue, sales-leadership, commercial-strategy]
...
okb_bundle_id: chief-revenue-officer-cro
okb_bundle_version: 0.1.0
trust_tier: trusted
status: beta
license: CC-BY-4.0
related_bundles: [sales-manager, chief-marketing-officer-cmo, revenue-operations-revops-manager]
adjacent_bundles: [account-executive-closer, sales-enablement-manager, sales-pipeline-report]
contributors: [OpenKnowledgeBank]
maintainers: [OpenKnowledgeBank]
standard_mappings: {onet_soc: [11-2022.00], soc: [11-2022], isco_08: [1221], esco: []}
content_risk:
  classification: ymyl
  domains: [financial, legal, employment, privacy]
  professional_review:
    status: not_reviewed
    required_qualification: A qualified commercial, finance, legal, privacy, employment, or revenue-operations professional appropriate to the market and jurisdiction.
limitations:
...
Use the [overview](overview.md), [role guide](role.md), [workflow](workflow.md), and [quality check](evaluations/quality-check.md). No pipeline, bookings, revenue recognition, pricing, retention, customer, contract, marketing, capacity, incentive, and forecast fact is assumed.
