---
type: Workflow
title: Systems / Infrastructure Engineer (Software) Source-Aware Triage
---

# Source-Aware Triage

1. State the requested decision or deliverable.
2. Inventory evidence: architecture and inventory, configuration and infrastructure code, SLO and capacity requirements, identity and network policy, telemetry and incident records, cost constraints, change and rollback procedures.
...
5. Produce the smallest reviewable Infrastructure change and reliability brief.
