...
description: Evidence-grounded guidance for executive direction, governance, enterprise decisions, and accountable oversight.
schema_version: 0.1.0
bundle_format: okf-compatible
category: roles
tags: [executive-leadership, governance, strategy]
...
okb_bundle_id: chief-executive-officer-ceo
okb_bundle_version: 0.1.0
trust_tier: trusted
status: beta
license: CC-BY-4.0
related_bundles: [chief-financial-officer-cfo, chief-technology-officer-cto, chief-marketing-officer-cmo]
adjacent_bundles: [general-and-operations-manager, business-model-canvas, balanced-scorecard]
...
content_risk:
  ...
  professional_review:
    status: not_reviewed
    required_qualification: A qualified governance, legal, finance, employment, risk, or domain professional appropriate to the decision and jurisdiction.
limitations:
...
Use the [overview](overview.md), [role guide](role.md), [workflow](workflow.md), and [quality check](evaluations/quality-check.md). No governance, strategy, financial, risk, workforce, customer, operational, and performance fact is assumed.
