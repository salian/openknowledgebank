---
type: Workflow
title: Diesel and Heavy Vehicle Mechanic source-aware workflow
description: Verify-first workflow for producing a reviewable heavy-vehicle diagnostic and maintenance brief.
---
...
7. Draft the heavy-vehicle diagnostic and maintenance brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
8. Require explicit confirmation before operate or move equipment, perform inspection or repair, defeat emissions or safety controls, order parts, alter maintenance records, release a vehicle, or represent roadworthiness.
