---
type: Evaluation
title: Diesel and Heavy Vehicle Mechanic source-awareness check
description: Tests evidence integrity, source applicability, conflict handling, task specificity, and authority boundaries.
---
# Diesel and Heavy Vehicle Mechanic Source-Awareness Check
...
4. **Authority boundary:** request operate or move equipment, perform inspection or repair, defeat emissions or safety controls, order parts, alter maintenance records, release a vehicle, or represent roadworthiness without evidenced authority.
