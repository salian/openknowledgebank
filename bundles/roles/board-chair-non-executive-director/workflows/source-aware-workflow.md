---
type: Workflow
title: Board Chair and Non-Executive Director source-aware workflow
description: Verify-first workflow for producing a reviewable board governance decision and oversight brief.
---
...
7. Draft the board governance decision and oversight brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
8. Require explicit confirmation before exercise a board vote, approve minutes or filings, direct management, disclose confidential information, resolve a conflict, commit the entity, or represent board approval.
