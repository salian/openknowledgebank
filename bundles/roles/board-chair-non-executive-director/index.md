---
type: Bundle Index
title: Board Chair and Non-Executive Director
description: Evidence-grounded preparation for board agendas, governance information, challenge, oversight, conflicts, decisions, minutes, and follow-up without assuming director authority or legal duties.
category: roles
version: 0.1.0
tags:
- board-governance
...
skills: []
evaluations:
- Board Chair and Non-Executive Director source-awareness check
trust_tier: trusted
status: beta
license: CC-BY-4.0
related_bundles:
...
okb_bundle_id: board-chair-non-executive-director
...
Use this bundle to prepare a reviewable **board governance decision and oversight brief** without inventing local facts, configuration, evidence, results, permissions, or authority.
...
- [Board Chair and Non-Executive Director Source-Aware Guide](role.md)
- [Source-aware workflow](workflows/source-aware-workflow.md)
- [board governance decision and oversight brief](deliverables/board-chair-non-executive-director-brief.md)
