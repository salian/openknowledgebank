---
type: Workflow
title: Cost Estimator source-aware triage
---
# Source-Aware Triage

1. State the requested decision or artifact.
2. Inventory evidence: project, scope, drawings, specifications, and versions; quantities and takeoff method; labor, material, equipment, rates, vendor quotes, and dates; productivity, overhead, escalation, contingency, exclusions, risks, reconciliation, and approvals.
...
5. Produce the smallest reviewable cost estimate basis brief.
