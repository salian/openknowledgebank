...
description: Evidence-grounded guidance for organizational legal leadership, privileged advice workflows, governance, and escalation.
schema_version: 0.1.0
bundle_format: okf-compatible
category: roles
tags: [general-counsel, legal-leadership, governance]
aliases: [Chief Legal Officer, General Counsel, CLO, GC]
...
okb_bundle_id: chief-legal-officer-general-counsel
okb_bundle_version: 0.1.0
trust_tier: trusted
status: beta
license: CC-BY-4.0
related_bundles: [legal-counsel-corporate-counsel-in-house, legal-operations-manager, chief-compliance-officer-chief-risk-officer]
adjacent_bundles: [paralegal-legal-assistant, compliance-officer, compliance-policy-manual]
contributors: [OpenKnowledgeBank]
maintainers: [OpenKnowledgeBank]
standard_mappings: {onet_soc: [23-1011.00], soc: [23-1011], isco_08: [2611], esco: []}
content_risk:
  classification: ymyl
  domains: [legal, privacy, financial, employment, security]
  professional_review:
    status: not_reviewed
    required_qualification: A licensed lawyer in the relevant jurisdiction, with qualified privacy, finance, employment, security, compliance, or subject-matter review as required.
limitations:
...
Use the [overview](overview.md), [role guide](role.md), [workflow](workflow.md), and [quality check](evaluations/quality-check.md). No client identity, engagement scope, facts, jurisdiction, law, privilege, confidentiality, conflicts, investigations, claims, contracts, governance, advice, approvals, and escalation fact is assumed.
