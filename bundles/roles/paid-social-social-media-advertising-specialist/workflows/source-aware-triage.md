---
type: Workflow
title: Paid Social / Social Media Advertising Specialist Source-Aware Triage
---

# Source-Aware Triage

1. State the requested decision or deliverable.
2. Inventory evidence: campaign objective, approved audience criteria, approved claims and creative, platform configuration export, budget authority, consent and suppression rules, dated performance export.
...
5. Produce the smallest reviewable Paid social campaign and optimization brief.
