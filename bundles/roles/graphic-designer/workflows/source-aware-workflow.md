---
type: Workflow
title: Graphic Designer source-aware workflow
description: Verify-first workflow for producing a reviewable graphic design review brief.
---
...
3. Inventory brief, audience, message, channel, dimensions, source assets, authorship, licenses, consent, brand rules, accessibility criteria, production specifications, review comments, and release approvals.
...
7. Draft the graphic design review brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
8. Require explicit confirmation before use unlicensed assets, publish identifiable people, claim accessibility conformance, alter approved brand assets, release files, or spend production budget.
