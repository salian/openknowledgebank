---
type: Workflow
title: Aircraft Mechanic and Avionics Technician source-aware workflow
description: Verify-first workflow for producing a reviewable aircraft maintenance or avionics work-control brief.
---
...
7. Draft the aircraft maintenance or avionics work-control brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
8. Require explicit confirmation before perform or sign maintenance, inspection, alteration, troubleshooting, testing, record approval, or return-to-service work; bypass safety controls; or represent airworthiness.
