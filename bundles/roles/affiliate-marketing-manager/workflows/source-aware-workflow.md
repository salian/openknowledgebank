---
type: Workflow
title: Affiliate Marketing Manager source-aware workflow
description: Verify-first workflow for producing a reviewable affiliate program governance and performance brief.
---
...
7. Draft the affiliate program governance and performance brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
8. Require explicit confirmation before perform licensed or safety-critical work, commit funds, change records or systems, contact an external party, make an employment decision, or represent approval.
