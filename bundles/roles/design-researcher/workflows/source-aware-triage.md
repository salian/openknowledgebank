---
type: Workflow
title: Design Researcher source-aware triage
---

# Source-Aware Triage

1. State the requested decision or artifact.
2. Inventory evidence: research question and decision; participant population, recruitment criteria, consent, and incentives; current protocol, script, and method; recordings, notes, data handling, and retention; analysis method, coding, synthesis, and contrary evidence; accessibility, safeguarding, limitations, and stakeholder review.
...
5. Produce the smallest reviewable design research brief.
