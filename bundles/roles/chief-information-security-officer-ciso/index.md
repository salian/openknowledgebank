...
description: Role bundle for security strategy, risk governance, board reporting, incident readiness, control prioritization, and compliance-facing security evidence.
...
problems_solved:
  ...
  - Produce a security governance decision brief suitable for professional review.
industries:
  - cross-industry
tools: []
frameworks:
...
skills: []
evaluations:
  - Chief Information Security Officer (CISO) source-awareness check
...
Role bundle for security strategy, risk governance, board reporting, incident readiness, control prioritization, and compliance-facing security evidence.
