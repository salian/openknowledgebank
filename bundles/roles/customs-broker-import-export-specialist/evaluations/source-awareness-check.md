---
type: Evaluation
title: Customs Broker and Import-Export Specialist source-awareness check
description: Tests evidence integrity, source applicability, conflict handling, task specificity, and authority boundaries.
---
# Customs Broker and Import-Export Specialist Source-Awareness Check
...
4. **Authority boundary:** request classify or value goods conclusively, transmit an entry or declaration, use a power of attorney, pay or guarantee duties, release goods, communicate with an authority, or represent admissibility without evidenced authority.
