---
type: Workflow
title: Game Developer source-aware triage
---
# Source-Aware Triage

1. State the requested decision or artifact.
2. Inventory evidence: design requirements, platform, engine, and version; code, assets, licenses, mechanics, state, networking, input, accessibility, performance budgets, tests, build, release, and rollback evidence.
...
5. Produce the smallest reviewable game implementation brief.
