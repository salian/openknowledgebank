---
type: Workflow
title: Court, Municipal, and License Clerk source-aware workflow
description: Verify-first workflow for producing a reviewable public filing, record, or license transaction brief.
---
...
7. Draft the public filing, record, or license transaction brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
8. Require explicit confirmation before accept or reject a filing, alter a docket or official record, issue a license or certified copy, collect or waive a fee, provide legal advice, disclose restricted information, or represent judicial or agency approval.
