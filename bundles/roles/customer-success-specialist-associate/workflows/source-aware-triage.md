---
type: Workflow
title: Customer Success Specialist / Associate source-aware triage
---

# Source-Aware Triage

1. State the requested decision or artifact.
2. Inventory evidence: account, contract, products, stakeholders, and permissions; customer goals and agreed outcomes; adoption and health definitions with dated evidence; interaction and support history; risks, issues, and escalation ownership; renewal terms and personal-data handling.
...
5. Produce the smallest reviewable customer success account brief.
