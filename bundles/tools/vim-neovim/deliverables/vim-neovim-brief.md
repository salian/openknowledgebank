---
type: Deliverable
title: Vim and Neovim configuration review brief
description: Review-ready template for Vim and Neovim evidence, decisions, validation, and controlled next actions.
---
# Vim and Neovim configuration review brief
...
- Prohibited without explicit confirmation: execute editor or shell commands, install plugins, source untrusted configuration, overwrite files, change permissions, expose content, or replace production configuration.
