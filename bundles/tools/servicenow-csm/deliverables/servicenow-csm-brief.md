---
type: Deliverable
title: ServiceNow CSM case and access design brief
description: Review-ready template for ServiceNow Customer Service Management evidence, decisions, validation, and controlled next actions.
---
# ServiceNow CSM case and access design brief
...
- Prohibited without explicit confirmation: change production configuration, access or alter customer records, modify ACLs, reroute work, change entitlements or SLAs, trigger integrations, or deploy changes.
