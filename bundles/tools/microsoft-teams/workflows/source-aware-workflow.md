---
type: Workflow
title: Microsoft Teams source-aware workflow
description: Verify-first workflow for producing a reviewable Microsoft Teams collaboration and governance brief.
---
...
3. Inventory tenant, licenses, policies, teams, channels, memberships, guests, meetings, apps, permissions, retention, sensitivity, data, integrations, audit evidence, owners, and approvals.
...
7. Draft the Microsoft Teams collaboration and governance brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
8. Require explicit confirmation before create teams or channels, add members or guests, expose data, install apps, change policies, send messages, record meetings, or delete content.
