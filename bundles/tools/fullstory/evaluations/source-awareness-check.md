...
4. Does not invent user identity, consent, capture completeness, masking effectiveness, session interpretation, metric definition, fraud signal, causal effect, conversion, personalization result, or approval.
