---
type: Deliverable
title: Power Automate flow design and control brief
description: Review-ready template for Microsoft Power Automate evidence, decisions, validation, and controlled next actions.
---
# Power Automate flow design and control brief
...
- Prohibited without explicit confirmation: activate flows, use credentials, read or write records, send messages, bypass DLP controls, trigger downstream actions, or incur spend.
