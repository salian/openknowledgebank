---
type: Workflow
title: Microsoft Power Automate source-aware workflow
description: Verify-first workflow for producing a reviewable Power Automate flow design and control brief.
---
...
3. Inventory tenant, environment, licenses, flow type, triggers, actions, connectors, connection references, credential scopes, schemas, DLP policies, error handling, run history, tests, owners, and approvals.
...
7. Draft the Power Automate flow design and control brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
8. Require explicit confirmation before activate flows, use credentials, read or write records, send messages, bypass DLP controls, trigger downstream actions, or incur spend.
