---
type: Deliverable
title: Sales Cloud process and governance brief
description: Review-ready template for Salesforce Sales Cloud evidence, decisions, validation, and controlled next actions.
---
# Sales Cloud process and governance brief
...
- Prohibited without explicit confirmation: change production metadata, modify customer records, expose personal data, alter access, scoring, forecasts, or automation, trigger outreach, or deploy changes.
