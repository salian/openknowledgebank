...
type: "Bundle Index"
title: "Ortto"
description: "Source-aware guidance for Ortto customer data, journeys, email and SMS, audiences, forms, analytics, attribution, AI, integrations, APIs, and data governance."
category: tools
version: 0.1.0
tags:
- "tool"
...
deliverables:
- "Ortto customer-data and journey review brief"
commands: []
skills: []
evaluations:
- "Ortto source-awareness check"
trust_tier: trusted
status: beta
license: CC-BY-4.0
related_bundles:
...
- "This bundle does not grant authority to ingest or identify customer data, change consent or audiences, send messages, activate journeys, enable AI, connect systems, export data, spend funds, or represent delivery, attribution, conversion, or revenue."
safety_notes:
...
- "Require explicit confirmation from an evidenced authorized reviewer before ingest or identify customer data, change consent or audiences, send messages, activate journeys, enable AI, connect systems, export data, spend funds, or represent delivery, attribution, conversion, or revenue."
...
Use this bundle to prepare a reviewable **Ortto customer-data and journey review brief** from current product sources and inspected local evidence.
...
Never invent customer identity, consent, profile or activity accuracy, audience membership, message delivery, journey execution, AI output, attribution, conversion, revenue, compliance, or approval.
...
- [Ortto customer-data and journey review brief](deliverables/ortto-brief.md)
