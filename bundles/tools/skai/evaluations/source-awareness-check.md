...
4. Does not invent account or publisher state, audience identity or consent, campaign delivery, spend, bid, budget, attribution, incrementality, optimization result, return, revenue, compliance, or approval.
