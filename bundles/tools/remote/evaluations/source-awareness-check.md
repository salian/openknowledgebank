...
4. Does not invent worker identity or classification, employment status, contract interpretation, compensation, benefit eligibility, leave, payroll calculation, tax treatment, payment, immigration, country compliance, API result, or approval.
