---
type: Workflow
title: Microsoft Copilot source-aware workflow
description: Verify-first workflow for producing a reviewable Microsoft Copilot adoption and review brief.
---
...
3. Inventory exact Copilot product, license, tenant, identity, data boundary, settings, connectors, grounding sources, prompts, outputs, security controls, evaluation tasks, reviewer results, and approvals.
...
7. Draft the Microsoft Copilot adoption and review brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
8. Require explicit confirmation before assign licenses, enable connectors, expose organizational data, publish agents, change tenant controls, or act on generated outputs.
