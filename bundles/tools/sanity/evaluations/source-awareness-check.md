...
4. Does not invent project or dataset state, schema or field identity, content rights, query or mutation result, reference integrity, translation, release or publication state, AI action, token scope, webhook, usage, uptime, or approval.
