---
type: Workflow
title: Klaviyo source-aware workflow
description: Verify-first workflow for producing a reviewable Klaviyo campaign, consent, and API-control brief.
---
...
3. Inventory account, plan, API revision, profiles, identifiers, consent and suppression status, lists, segments, events, metrics, catalogs, templates, campaigns, flows, channels, credentials, scopes, rate limits, integrations, attribution plan, tests, owners, and approvals.
...
7. Draft the Klaviyo campaign, consent, and API-control brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
8. Require explicit confirmation before use API keys, access or alter profiles, change consent or suppression, send campaigns or messages, activate flows, upload audiences, incur spend, or deploy integrations.
