---
type: Deliverable
title: Klaviyo campaign, consent, and API-control brief
description: Review-ready template for Klaviyo evidence, decisions, validation, and controlled next actions.
---
# Klaviyo campaign, consent, and API-control brief
...
- Prohibited without explicit confirmation: use API keys, access or alter profiles, change consent or suppression, send campaigns or messages, activate flows, upload audiences, incur spend, or deploy integrations.
