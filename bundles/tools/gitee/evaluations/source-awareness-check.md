...
4. Does not invent code ownership, repository contents, branch or review state, access, workflow result, artifact provenance, security, deployment, license compliance, or approval.
