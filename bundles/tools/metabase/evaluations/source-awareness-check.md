...
4. Does not invent schema, field semantics, query correctness, metric definition, row or column security, data freshness, dashboard result, export completeness, embed access, backup validity, uptime, or approval.
