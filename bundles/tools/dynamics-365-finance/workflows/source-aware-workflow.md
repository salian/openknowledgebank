---
type: Workflow
title: Dynamics 365 Finance source-aware workflow
description: Verify-first workflow for producing a reviewable Dynamics 365 Finance change and control brief.
---
...
3. Inventory tenant, environment, release, legal entities, chart of accounts, dimensions, periods, workflows, roles, integrations, transactions, reconciliations, tests, owners, and approvals.
...
7. Draft the Dynamics 365 Finance change and control brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
8. Require explicit confirmation before post or alter transactions, change ledgers or periods, modify workflows or roles, expose financial data, run settlement, or release production changes.
