---
type: Deliverable
title: Dynamics 365 Finance change and control brief
description: Review-ready template for Dynamics 365 Finance evidence, decisions, validation, and controlled next actions.
---
...
- Prohibited without explicit confirmation: post or alter transactions, change ledgers or periods, modify workflows or roles, expose financial data, run settlement, or release production changes.
