---
type: Deliverable
title: ZoomInfo Sales data-use and integration brief
description: Review-ready template for ZoomInfo Sales evidence, decisions, validation, and controlled next actions.
---
# ZoomInfo Sales data-use and integration brief
...
- Prohibited without explicit confirmation: access or export contact data, enrich records, change CRM data, create lists, trigger outreach, bypass suppression, share data, or deploy integrations.
