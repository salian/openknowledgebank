---
type: Workflow
title: ZoomInfo Sales source-aware workflow
description: Verify-first workflow for producing a reviewable ZoomInfo Sales data-use and integration brief.
---
...
3. Inventory subscription, product modules, user roles, data sources, records, fields, confidence and freshness indicators, suppression requirements, territories, CRM mappings, integrations, credentials, usage limits, owners, and approvals.
...
7. Draft the ZoomInfo Sales data-use and integration brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
8. Require explicit confirmation before access or export contact data, enrich records, change CRM data, create lists, trigger outreach, bypass suppression, share data, or deploy integrations.
