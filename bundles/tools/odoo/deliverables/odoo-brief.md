---
type: Deliverable
title: Odoo integration and change brief
description: Review-ready template for Odoo evidence, decisions, validation, and controlled next actions.
---
# Odoo integration and change brief
...
- Prohibited without explicit confirmation: install modules, use credentials, modify records, post transactions, change access, run automation, expose data, or deploy production changes.
