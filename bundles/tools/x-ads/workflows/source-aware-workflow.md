---
type: Workflow
title: X Ads source-aware workflow
description: Verify-first workflow for producing a reviewable X Ads campaign and spend-control brief.
---
...
3. Inventory ad account, funding instrument, objective, campaign, ad groups, targeting, creatives, landing pages, budgets, bids, dates, tracking, policies, consent, measurement plan, owners, and approvals.
...
7. Draft the X Ads campaign and spend-control brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
8. Require explicit confirmation before create or activate campaigns, change targeting, publish ads, use customer audiences, alter budgets or bids, connect tracking, or incur spend.
