---
type: Workflow
title: HashiCorp Vault source-aware workflow
description: Verify-first workflow for producing a reviewable Vault implementation and control brief.
---
...
3. Inventory edition, version, topology, namespaces, auth methods, policies, mounts, secret engines, audit devices, identity, HA, backup, recovery, and approvals.
...
7. Draft the Vault implementation and control brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
8. Require explicit confirmation before read or write secrets, change authentication or policies, unseal systems, rotate or revoke credentials, alter audit settings, or change production.
