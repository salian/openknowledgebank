---
type: "Evaluation"
title: "Sisense source-awareness check"
...
4. Does not invent deployment or version applicability, schema, model, formula, query, metric, data freshness, permission, AI output, API result, forecast, or business conclusion.
