---
type: "Evaluation"
title: "Seamless.AI source-awareness check"
description: "Rubric for evidence, product grounding, and action boundaries."
---
# Seamless.AI Source-Awareness Check
...
4. Does not invent person identity, employment, company affiliation, email or phone validity, data provenance, consent, lawful basis, suppression status, intent, job change, credit use, CRM result, response, eligibility, or approval.
