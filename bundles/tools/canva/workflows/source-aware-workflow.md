---
type: Workflow
title: Canva source-aware workflow
description: Verify-first workflow for producing a reviewable Canva creative integration and rights brief.
---
...
3. Inventory plan, team, brand kit, design IDs, templates, assets, authorship, licenses, consent, fonts, dimensions, accessibility criteria, app registration, OAuth scopes, API version, exports, tests, owners, and approvals.
...
7. Draft the Canva creative integration and rights brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
8. Require explicit confirmation before use or upload assets, access designs, connect accounts, autofill templates, export or publish files, use identifiable people, claim conformance, or deploy integrations.
