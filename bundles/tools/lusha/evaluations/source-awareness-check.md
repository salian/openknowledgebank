...
4. Does not invent person identity, contact accuracy, employment or company state, lawful basis, consent, intent signal, match or enrichment accuracy, CRM write, credit use, outreach authority, compliance, or approval.
