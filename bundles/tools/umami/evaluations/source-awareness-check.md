...
4. Does not invent deployment or version applicability, visitor identity, consent requirement, event semantics, metric definition, data completeness or freshness, attribution, API result, privacy compliance, availability, or business conclusion.
