---
type: Workflow
title: Asana source-aware workflow
description: Verify-first workflow for producing a reviewable Asana workspace and automation brief.
---
...
3. Inventory organization or workspace, plan, users, teams, projects, portfolios, tasks, custom fields, dependencies, goals, rules, sharing, permissions, integration type, token scopes, webhooks, tests, owners, and approvals.
...
7. Draft the Asana workspace and automation brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
8. Require explicit confirmation before access or alter work data, create or delete tasks, change assignments or dates, use credentials, share projects, trigger rules, make employment conclusions, or deploy integrations.
