---
type: "Evaluation"
title: "Reply.io source-awareness check"
...
4. Does not invent contact identity, lawful basis, consent, suppression status, email validity, deliverability, send or social action, AI response, reply intent, lead state, attribution, pipeline, revenue, or approval.
