---
type: Workflow
title: CapCut source-aware workflow
description: Verify-first workflow for producing a reviewable CapCut production and rights brief.
---
...
3. Inventory product surface, app version, device, account and plan, project files, source media, authorship, licenses, consent, music and templates, AI feature inputs and outputs, captions, dimensions, color, audio, export settings, tests, owners, and approvals.
...
7. Draft the CapCut production and rights brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
8. Require explicit confirmation before upload sensitive media, use faces or voices, use licensed music or templates, invoke AI features, overwrite projects, remove metadata, export or publish videos, or claim accessibility.
