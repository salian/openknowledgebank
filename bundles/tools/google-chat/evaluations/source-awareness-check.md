---
type: "Evaluation"
title: "Google Chat source-awareness check"
...
4. Does not invent identity, membership, message content, delivery, task state, file access, app behavior, OAuth authorization, retention, migration completeness, or approval.
