...
4. Does not invent balance or transaction accuracy, account ownership, rule validity, reconciliation completeness, exception resolution, journal support, close status, audit assurance, or approval.
