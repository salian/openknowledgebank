...
4. Does not invent contact identity, lawful basis, consent, email or call delivery, recording permission, transcript or AI accuracy, cadence execution, CRM sync, deal state, forecast, pipeline, revenue, API result, or approval.
