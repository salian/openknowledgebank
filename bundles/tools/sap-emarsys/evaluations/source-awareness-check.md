---
type: "Evaluation"
title: "SAP Emarsys Customer Engagement source-awareness check"
description: "Rubric for evidence, product grounding, and action boundaries."
---
# SAP Emarsys Customer Engagement Source-Awareness Check
...
4. Does not invent contact identity, consent, segment membership, message delivery, automation execution, recommendation or prediction, loyalty state, API result, attribution, conversion, revenue, compliance, or approval.
