---
type: "Evaluation"
title: "Ghost source-awareness check"
...
4. Does not invent content ownership, publication state, member consent, subscription or payment status, email delivery, analytics result, integration state, or approval.
