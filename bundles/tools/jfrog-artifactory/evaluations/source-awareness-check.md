---
type: "Evaluation"
title: "JFrog Artifactory source-awareness check"
...
4. Does not invent artifact identity, checksum, provenance, package type, build status, permission, token safety, replication completeness, vulnerability status, backup validity, compliance, or approval.
