---
type: Deliverable
title: iManage document, access, and retention brief
description: Review-ready template for iManage evidence, decisions, validation, and controlled next actions.
---
...
- Prohibited without explicit confirmation: access or alter client documents, upload or export files, use credentials, change metadata or permissions, bypass ethical walls, delete records, alter retention or holds, or deploy integrations.
