---
type: Deliverable
title: ADP Workforce Now integration and payroll-control brief
description: Review-ready template for ADP Workforce Now evidence, decisions, validation, and controlled next actions.
---
# ADP Workforce Now integration and payroll-control brief
...
- Prohibited without explicit confirmation: access or alter worker data, change compensation, benefits, tax, time, deductions, or payroll instructions, use credentials, transmit sensitive data, make employment decisions, or deploy integrations.
