---
type: Deliverable
title: Workday Recruiting configuration and fairness brief
description: Review-ready template for Workday Recruiting evidence, decisions, validation, and controlled next actions.
---
# Workday Recruiting configuration and fairness brief
...
- Prohibited without explicit confirmation: change production recruiting configuration, access or alter candidate data, change routing or screening, send communications, make employment decisions, or deploy changes.
