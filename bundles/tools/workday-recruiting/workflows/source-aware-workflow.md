---
type: Workflow
title: Workday Recruiting source-aware workflow
description: Verify-first workflow for producing a reviewable Workday Recruiting configuration and fairness brief.
---
...
3. Inventory tenant, release, subscriptions, security domains, job requisitions, candidate stages, business processes, condition rules, questionnaires, integrations, candidate data, fairness evidence, tests, owners, and approvals.
...
7. Draft the Workday Recruiting configuration and fairness brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
8. Require explicit confirmation before change production recruiting configuration, access or alter candidate data, change routing or screening, send communications, make employment decisions, or deploy changes.
