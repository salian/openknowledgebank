---
type: Deliverable
title: Looker model and data-governance brief
description: Review-ready template for Looker evidence, decisions, validation, and controlled next actions.
---
# Looker model and data-governance brief
...
- Prohibited without explicit confirmation: change LookML or production projects, use credentials, query or expose sensitive data, alter access, schedule delivery, publish content, or deploy changes.
