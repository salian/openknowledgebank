---
type: "Evaluation"
title: "Optro (formerly AuditBoard) source-awareness check"
description: "Rubric for evidence, product grounding, and action boundaries."
---
# Optro (formerly AuditBoard) Source-Awareness Check
...
4. Does not invent migration or support status, control design, evidence sufficiency, test result, issue status, risk rating, regulatory compliance, assurance, or approval.
