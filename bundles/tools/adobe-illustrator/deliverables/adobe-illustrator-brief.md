---
type: Deliverable
title: Illustrator production and rights brief
description: Review-ready template for Adobe Illustrator evidence, decisions, validation, and controlled next actions.
---
# Illustrator production and rights brief
...
- Prohibited without explicit confirmation: open untrusted files, use or embed assets and fonts, run scripts, overwrite sources, convert color, remove metadata, export or publish artwork, or claim conformance.
