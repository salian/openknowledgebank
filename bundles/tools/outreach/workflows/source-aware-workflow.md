---
type: Workflow
title: Outreach source-aware workflow
description: Verify-first workflow for producing a reviewable Outreach sequence and compliance brief.
---
...
3. Inventory org, subscription, users, roles, mailboxes, prospects, accounts, sequences, steps, schedules, templates, opt-outs, territories, CRM mappings, OAuth scopes, API version, tests, owners, and approvals.
...
7. Draft the Outreach sequence and compliance brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
8. Require explicit confirmation before enroll prospects, send communications, use credentials, change customer records, alter schedules or sequences, bypass opt-outs, automate calls, or deploy integrations.
