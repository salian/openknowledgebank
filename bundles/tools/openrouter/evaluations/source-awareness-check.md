---
type: "Evaluation"
title: "OpenRouter source-awareness check"
...
4. Does not invent model or provider availability, routing outcome, data retention, privacy policy applicability, tool execution, output accuracy, safety, token use, latency, price, charge, or approval.
