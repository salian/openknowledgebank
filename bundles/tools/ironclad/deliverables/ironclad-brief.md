---
type: Deliverable
title: Ironclad contract workflow and control brief
description: Review-ready template for Ironclad evidence, decisions, validation, and controlled next actions.
---
...
- Prohibited without explicit confirmation: launch or alter workflows, create or modify contract records, use credentials, expose privileged data, change permissions, approve or sign agreements, export records, or deploy integrations.
