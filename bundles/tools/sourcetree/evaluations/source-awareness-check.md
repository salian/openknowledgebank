---
type: "Evaluation"
title: "Sourcetree source-awareness check"
...
4. Does not invent repository identity or state, file ownership, diff correctness, credential safety, merge result, history rewrite, remote synchronization, deployment, release status, or approval.
