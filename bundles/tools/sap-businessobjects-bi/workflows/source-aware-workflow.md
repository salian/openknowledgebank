---
type: Workflow
title: SAP BusinessObjects BI source-aware workflow
description: Verify-first workflow for producing a reviewable SAP BusinessObjects BI reporting and governance brief.
---
...
3. Inventory edition, version, landscape, CMS, repositories, universes, connections, credentials, reports, prompts, schedules, destinations, roles, data classifications, tests, owners, and approvals.
...
7. Draft the SAP BusinessObjects BI reporting and governance brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
8. Require explicit confirmation before change production universes or reports, use credentials, expose data, alter permissions, schedule distribution, publish outputs, or deploy changes.
