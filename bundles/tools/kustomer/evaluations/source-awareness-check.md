...
4. Does not invent customer identity, context, entitlement, conversation state, response accuracy, AI reasoning or action, resolution, satisfaction, retention, revenue, compliance, or approval.
