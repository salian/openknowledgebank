---
type: Deliverable
title: DaVinci Resolve production and delivery brief
description: Review-ready template for DaVinci Resolve evidence, decisions, validation, and controlled next actions.
---
# DaVinci Resolve production and delivery brief
...
- Prohibited without explicit confirmation: open untrusted projects, use media or plugins, run scripts, overwrite source or project data, change color or audio, export or publish media, or claim conformance.
