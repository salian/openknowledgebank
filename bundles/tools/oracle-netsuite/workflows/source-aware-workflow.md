---
type: Workflow
title: Oracle NetSuite source-aware workflow
description: Verify-first workflow for producing a reviewable NetSuite ERP change and control brief.
---
...
3. Inventory account, edition, release, subsidiaries, currencies, chart of accounts, periods, roles, permissions, records, workflows, scripts, SuiteApps, integrations, transactions, reconciliations, tests, owners, and approvals.
...
7. Draft the NetSuite ERP change and control brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
8. Require explicit confirmation before post or alter transactions, change accounting configuration or periods, modify roles, run scripts, use credentials, expose financial data, or deploy changes.
