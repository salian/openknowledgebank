...
4. Does not invent ticket classification or state, ownership, SLA, root cause, asset or configuration state, change approval, automation result, billing, service restoration, compliance, or approval.
