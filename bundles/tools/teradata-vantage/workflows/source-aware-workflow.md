---
type: Workflow
title: Teradata Vantage source-aware workflow
description: Verify-first workflow for producing a reviewable Teradata Vantage workload and data governance brief.
---
...
3. Inventory edition, version, environment, databases, schemas, tables, views, data classifications, users, roles, privileges, SQL, statistics, workloads, query plans, performance evidence, backups, tests, owners, and approvals.
...
7. Draft the Teradata Vantage workload and data governance brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
8. Require explicit confirmation before run mutating SQL, access or export sensitive data, change schemas or privileges, collect statistics, alter workloads, terminate sessions, or deploy production changes.
