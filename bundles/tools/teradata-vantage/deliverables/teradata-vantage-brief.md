---
type: Deliverable
title: Teradata Vantage workload and data governance brief
description: Review-ready template for Teradata Vantage evidence, decisions, validation, and controlled next actions.
---
# Teradata Vantage workload and data governance brief
...
- Prohibited without explicit confirmation: run mutating SQL, access or export sensitive data, change schemas or privileges, collect statistics, alter workloads, terminate sessions, or deploy production changes.
