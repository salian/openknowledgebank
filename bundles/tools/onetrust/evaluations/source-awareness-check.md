...
4. Does not invent identity, consent, jurisdiction, tracker classification, data inventory, rights-request status, vendor or AI risk, control effectiveness, legal applicability, compliance, certification, or approval.
