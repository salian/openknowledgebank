---
type: "Evaluation"
title: "Mailshake source-awareness check"
...
4. Does not invent contact identity, lawful basis, consent, suppression status, email validity, deliverability, send state, reply intent, lead status, attribution, pipeline, revenue, or approval.
