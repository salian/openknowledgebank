...
type: "Bundle Index"
title: "Mailshake"
description: "Source-aware guidance for Mailshake cold-email campaigns, sequences, personalization, deliverability, lead workflows, multichannel outreach, analytics, integrations, and API use."
category: tools
version: 0.1.0
tags:
- "tool"
...
deliverables:
- "Mailshake outreach and deliverability review brief"
commands: []
skills: []
evaluations:
- "Mailshake source-awareness check"
trust_tier: trusted
status: beta
license: CC-BY-4.0
related_bundles:
...
- "This bundle does not grant authority to import or enrich contacts, send outreach, change lead status, use data credits, connect CRM systems, expose API keys, or represent consent, delivery, response, pipeline, or revenue."
safety_notes:
...
- "Require explicit confirmation from an evidenced authorized reviewer before import or enrich contacts, send outreach, change lead status, use data credits, connect CRM systems, expose API keys, or represent consent, delivery, response, pipeline, or revenue."
timestamp: "2026-08-14T00:00:00Z"
schema_version: 0.1.0
bundle_format: okf-compatible
okb_bundle_id: mailshake
...
Use this bundle to prepare a reviewable **Mailshake outreach and deliverability review brief** from current product sources and inspected local evidence.
...
Never invent contact identity, lawful basis, consent, suppression status, email validity, deliverability, send state, reply intent, lead status, attribution, pipeline, revenue, or approval.
...
- [Mailshake outreach and deliverability review brief](deliverables/mailshake-brief.md)
