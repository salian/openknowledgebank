---
type: Workflow
title: Zoom Workplace source-aware workflow
description: Verify-first workflow for producing a reviewable Zoom Workplace collaboration and governance brief.
---
...
3. Inventory account, plan, release, users, groups, roles, meeting and webinar settings, recordings, transcripts, apps, OAuth scopes, webhooks, retention, consent, data regions, tests, owners, and approvals.
...
7. Draft the Zoom Workplace collaboration and governance brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
8. Require explicit confirmation before change account settings, add users or apps, use credentials, expose meeting data, record or transcribe participants, send invitations, delete content, or deploy integrations.
