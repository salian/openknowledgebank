...
4. Does not invent product ownership or feature applicability, learner identity, enrollment, completion, assessment validity, competency, certification, content rights, AI output, API result, payment, compliance, or approval.
