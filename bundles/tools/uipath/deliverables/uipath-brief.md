---
type: Deliverable
title: UiPath automation design and control brief
description: Review-ready template for UiPath evidence, decisions, validation, and controlled next actions.
---
# UiPath automation design and control brief
...
- Prohibited without explicit confirmation: publish or run automation, use credentials, access or alter records, send messages, change schedules, operate user interfaces, trigger downstream systems, or deploy production.
