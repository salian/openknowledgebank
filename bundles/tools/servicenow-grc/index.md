...
description: "Source-aware guidance for current ServiceNow Integrated Risk Management policies, controls, risks, compliance, audits, issues, third parties, resilience, privacy, ESG, workflows, analytics, integrations, and AI."
category: tools
version: 0.1.0
tags:
- "tool"
...
skills: []
evaluations:
- "ServiceNow Integrated Risk Management source-awareness check"
trust_tier: trusted
status: beta
license: CC-BY-4.0
related_bundles:
...
Use this bundle to prepare a reviewable **ServiceNow IRM risk, control, and workflow review brief** from current product sources and inspected local evidence.
...
Never invent product or release applicability, record identity, risk score, control design or effectiveness, test result, finding, issue closure, exception, risk acceptance, third-party status, AI output, compliance, audit conclusion, or approval.
...
- [ServiceNow IRM risk, control, and workflow review brief](deliverables/servicenow-grc-brief.md)
