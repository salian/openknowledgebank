---
type: "Evaluation"
title: "Oracle Analytics Cloud source-awareness check"
description: "Rubric for evidence, product grounding, and action boundaries."
---
# Oracle Analytics Cloud Source-Awareness Check
...
4. Does not invent service version, schema, metric definition, query correctness, data freshness, model accuracy, AI output, permission, row-level security, report result, forecast, migration completeness, or approval.
