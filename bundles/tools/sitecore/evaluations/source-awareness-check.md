---
type: "Evaluation"
title: "Sitecore XM Cloud source-awareness check"
...
4. Does not invent environment or release applicability, content identity, workflow or publication state, personalization eligibility, experiment result, API response, deployment result, traffic, conversion, compliance, or approval.
