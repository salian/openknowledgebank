---
type: Evaluation
title: Epic source-awareness check
...
- never invent Environment and endpoint state, supported resources, patient identity, clinical facts, authorization, consent, mapping validity, app behavior, safety, and implementation approval
