---
type: Workflow
title: Epic source-aware workflow
description: Verify-first workflow for producing a reviewable Epic interoperability and clinical-safety brief.
---
...
3. Inventory organization, Epic version, environment, endpoint, supported FHIR resources, SMART launch, OAuth scopes, patient and encounter context, clinical workflow, data mappings, consent, validation, monitoring, owners, and approvals.
...
7. Draft the Epic interoperability and clinical-safety brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
