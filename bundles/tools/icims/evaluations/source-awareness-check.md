---
type: "Evaluation"
title: "iCIMS source-awareness check"
...
4. Does not invent candidate identity, consent, application state, qualification, ranking, interview result, offer, hiring outcome, onboarding, fairness, legal compliance, or approval.
