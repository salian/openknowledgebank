...
4. Does not invent repository state, configuration validity, secret safety, dependency integrity, test validity, artifact provenance, deployment result, rollback viability, or approval.
