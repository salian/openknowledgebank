---
type: Deliverable
title: Make automation design brief
description: Review-ready template for Make evidence, decisions, validation, and controlled next actions.
---
# Make automation design brief
...
- Prohibited without explicit confirmation: activate scenarios, use credentials, read or write records, send messages, trigger downstream systems, expose data, or incur spend.
