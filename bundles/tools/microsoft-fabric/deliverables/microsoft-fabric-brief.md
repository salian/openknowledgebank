---
type: Deliverable
title: Microsoft Fabric workload and governance brief
description: Review-ready template for Microsoft Fabric evidence, decisions, validation, and controlled next actions.
---
# Microsoft Fabric workload and governance brief
...
- Prohibited without explicit confirmation: provision capacity, ingest or expose data, change permissions, run pipelines, publish models or reports, alter production, or incur spend.
