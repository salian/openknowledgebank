---
type: "Evaluation"
title: "SideFX Houdini source-awareness check"
description: "Rubric for evidence, product grounding, and action boundaries."
---
# SideFX Houdini Source-Awareness Check
...
4. Does not invent asset ownership, scene or node state, cache validity, simulation accuracy, render settings, color result, plug-in safety, license entitlement, resource use, output quality, delivery, or approval.
