---
type: Workflow
title: Oracle Fusion Cloud ERP source-aware workflow
description: Verify-first workflow for producing a reviewable Oracle Fusion Cloud ERP implementation and control brief.
---
...
3. Inventory pod, release, subscriptions, legal entities, ledgers, business units, chart of accounts, periods, roles, workflows, integrations, transactions, reconciliations, tests, owners, and approvals.
...
7. Draft the Oracle Fusion Cloud ERP implementation and control brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
8. Require explicit confirmation before post or alter transactions, change ledgers or periods, modify roles or workflows, expose financial data, run settlement, or release production changes.
