---
type: "Evaluation"
title: "Kontent.ai source-awareness check"
description: "Rubric for evidence, product grounding, and action boundaries."
---
# Kontent.ai Source-Awareness Check
...
4. Does not invent content rights, model or item state, translation, workflow approval, publication, API-key scope, agent action, AI accuracy, governance certification applicability, delivery, compliance, or approval.
