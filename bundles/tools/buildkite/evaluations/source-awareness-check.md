---
type: "Evaluation"
title: "Buildkite source-awareness check"
...
4. Does not invent repository or pipeline state, credential safety, build reproducibility, test validity, artifact integrity, deployment result, rollback viability, or approval.
