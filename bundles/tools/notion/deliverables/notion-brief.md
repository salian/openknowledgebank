---
type: Deliverable
title: Notion workspace and integration brief
description: Review-ready template for Notion evidence, decisions, validation, and controlled next actions.
---
# Notion workspace and integration brief
...
- Prohibited without explicit confirmation: access or alter content, share pages, use credentials, change permissions, create or delete records, expose sensitive data, trigger automation, or deploy integrations.
