---
type: Workflow
title: Notion source-aware workflow
description: Verify-first workflow for producing a reviewable Notion workspace and integration brief.
---
...
3. Inventory workspace, plan, users, teams, pages, data sources or databases, properties, relations, sharing, permissions, integration type, bearer-token scope, API version, webhooks, retention, tests, owners, and approvals.
...
7. Draft the Notion workspace and integration brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
8. Require explicit confirmation before access or alter content, share pages, use credentials, change permissions, create or delete records, expose sensitive data, trigger automation, or deploy integrations.
