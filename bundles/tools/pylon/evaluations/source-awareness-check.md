...
4. Does not invent customer identity, channel membership, confidentiality, ticket state, SLA calculation, AI response, message delivery, resolution, sentiment, account health, retention, revenue, API result, or approval.
