...
4. Does not invent customer identity, ticket or order state, policy entitlement, refund or discount authority, response accuracy, AI action, resolution, CSAT, SLA, performance, or approval.
