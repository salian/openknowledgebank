---
type: "Evaluation"
title: "Foundry Nuke source-awareness check"
...
4. Does not invent product edition, version compatibility, source-media rights, frame range, color transform, node or script behavior, plugin safety, render completeness, visual accuracy, conform state, license, delivery, or approval.
