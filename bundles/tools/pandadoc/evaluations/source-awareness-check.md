...
4. Does not invent document ownership, content accuracy, recipient or signer identity, consent, signature validity, audit-trail completeness, contract status, legal effect, payment, webhook or API result, compliance, or approval.
