---
type: Deliverable
title: SuccessFactors Recruiting configuration and fairness brief
description: Review-ready template for SAP SuccessFactors Recruiting evidence, decisions, validation, and controlled next actions.
---
...
- Prohibited without explicit confirmation: change production recruiting configuration, access or alter candidate data, change screening or ranking, send communications, make employment decisions, or deploy changes.
