---
type: "Evaluation"
title: "Optum APIs (formerly Change Healthcare) source-awareness check"
...
4. Does not invent current product applicability, patient or member identity, authorization, eligibility or coverage, code or claim accuracy, payer adjudication, payment status, API result, regulatory compliance, or approval.
