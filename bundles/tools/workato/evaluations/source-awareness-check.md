...
4. Does not invent connection or recipe state, credential safety, trigger event, mapping correctness, job or agent execution, API result, transaction, data completeness, approval, compliance, or business completion.
