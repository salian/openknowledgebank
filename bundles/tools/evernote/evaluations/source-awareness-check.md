---
type: "Evaluation"
title: "Evernote source-awareness check"
...
4. Does not invent note ownership, source accuracy, transcription accuracy, task status, calendar state, sharing scope, AI output, retention, or approval.
