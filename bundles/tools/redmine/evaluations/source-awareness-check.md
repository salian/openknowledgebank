---
type: "Evaluation"
title: "Redmine source-awareness check"
...
4. Does not invent version or plugin compatibility, project or issue state, workflow transition, time accuracy, repository state, permission, API result, plugin safety, backup validity, migration, uptime, or approval.
