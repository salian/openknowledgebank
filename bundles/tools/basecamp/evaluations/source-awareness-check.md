...
4. Does not invent project scope, participant authority, task ownership or completion, schedule, file status, confidentiality, notification delivery, client approval, or authorization.
