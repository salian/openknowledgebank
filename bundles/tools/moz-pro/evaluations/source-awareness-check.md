---
type: "Evaluation"
title: "Moz Pro source-awareness check"
...
4. Does not invent site ownership, crawl completeness, search-engine index state, keyword volume, rank, visibility, link identity, metric definition, issue severity, traffic, causality, revenue, API result, or approval.
