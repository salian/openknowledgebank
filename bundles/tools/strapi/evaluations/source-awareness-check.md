...
4. Does not invent version or hosting applicability, schema, entry or publication state, media rights, permission, token safety, plugin behavior, API result, migration, backup or restore, availability, security, or approval.
