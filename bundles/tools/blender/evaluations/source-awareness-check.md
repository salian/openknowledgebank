---
type: "Evaluation"
title: "Blender source-awareness check"
...
4. Does not invent scene state, asset provenance or rights, script safety, compatibility, simulation or render result, color fidelity, output quality, publication, or approval.
