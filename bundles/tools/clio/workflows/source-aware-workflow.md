---
type: Workflow
title: Clio source-aware workflow
description: Verify-first workflow for producing a reviewable Clio matter, billing, and confidentiality brief.
---
...
3. Inventory region, account, subscription, API version, users, roles, matters, contacts, documents, communications, calendars, activities, bills, trust data, custom fields, OAuth scopes, retention, tests, owners, and approvals.
...
7. Draft the Clio matter, billing, and confidentiality brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
8. Require explicit confirmation before access or alter client or matter data, upload or export documents, use credentials, change time or billing records, move funds, send communications, modify permissions, or deploy integrations.
