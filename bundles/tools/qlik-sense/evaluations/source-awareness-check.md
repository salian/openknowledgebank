---
type: "Evaluation"
title: "Qlik Sense source-awareness check"
description: "Rubric for evidence, product grounding, and action boundaries."
---
# Qlik Sense Source-Awareness Check
...
4. Does not invent deployment or license applicability, schema, load completeness, metric definition, associative result, data freshness, section access, model accuracy, automation or API result, migration, business conclusion, or approval.
