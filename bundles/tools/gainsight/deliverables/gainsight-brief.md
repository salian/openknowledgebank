---
type: Deliverable
title: Gainsight customer-success model and control brief
description: Review-ready template for Gainsight evidence, decisions, validation, and controlled next actions.
---
...
- Prohibited without explicit confirmation: access or alter customer data, change health scores or rules, trigger CTAs or communications, use credentials, modify CRM records, make commercial decisions, or deploy integrations.
