---
type: Workflow
title: Gainsight source-aware workflow
description: Verify-first workflow for producing a reviewable Gainsight customer-success model and control brief.
---
...
3. Inventory tenant, product and release, licenses, users, roles, customer records, objects, fields, health scores, rules, CTAs, playbooks, journeys, integrations, credentials, API versions, tests, owners, and approvals.
...
7. Draft the Gainsight customer-success model and control brief, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
8. Require explicit confirmation before access or alter customer data, change health scores or rules, trigger CTAs or communications, use credentials, modify CRM records, make commercial decisions, or deploy integrations.
