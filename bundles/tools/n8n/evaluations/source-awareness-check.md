---
type: "Evaluation"
title: "n8n source-awareness check"
...
4. Does not invent credential scope, node behavior, input or output data, workflow execution, AI tool action, human review, webhook exposure, community-node safety, API result, deployment, availability, compliance, or approval.
