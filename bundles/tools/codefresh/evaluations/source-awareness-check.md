...
4. Does not invent repository or desired state, credential safety, pipeline validity, build or test result, environment drift, deployment health, promotion outcome, rollback viability, or approval.
