---
type: Deliverable
title: Availity transaction and data-control brief
description: Review-ready template for Availity evidence, decisions, validation, and controlled next actions.
---
# Availity transaction and data-control brief
...
- Prohibited without explicit confirmation: submit healthcare transactions, access eligibility or claims data, use credentials, alter records, transmit protected information, make coverage conclusions, or deploy integrations.
