...
description: Analysis of user drop-off and conversion through a defined funnel.
...
- site conversion rate optimization (CRO) report
problems_solved:
- Prepare a source-grounded Conversion Funnel Analysis.
...
skills: []
evaluations:
- Conversion Funnel Analysis source-awareness check
trust_tier: trusted
status: beta
license: CC-BY-4.0
related_bundles:
...
content_risk:
  ...
  professional_review:
    status: not_reviewed
    required_qualification: A qualified analytics, experimentation, statistics, privacy, finance, or domain professional appropriate to the data and decision.
limitations:
...
Use this bundle to prepare a reviewable **Conversion Funnel Analysis** without inventing local facts, configuration, evidence, results, permissions, or authority.
...
- [Conversion Funnel Analysis Source-Aware Guide](deliverable.md)
- [Source-aware workflow](workflows/source-aware-workflow.md)
- [Conversion Funnel Analysis](deliverables/conversion-funnel-analysis-brief.md)
