---
type: Bundle Index
title: Content Brief / Storyboard
description: Planning document outlining creative direction for a piece of content.
...
- storyboard
aliases:
- Content Brief / Storyboard
- content brief / storyboard
- SEO content brief
- content brief / assignment brief
problems_solved:
- Prepare a source-grounded Content Brief / Storyboard.
...
content_risk:
  ...
  professional_review:
    status: not_reviewed
    required_qualification: A qualified content, accessibility, intellectual-property, privacy, legal, or domain professional appropriate to the audience and channel.
limitations:
...
Use this bundle to prepare a reviewable **Content Brief / Storyboard** without inventing local facts, configuration, evidence, results, permissions, or authority.
...
- [Content Brief / Storyboard Source-Aware Guide](deliverable.md)
- [Source-aware workflow](workflows/source-aware-workflow.md)
- [Content Brief / Storyboard](deliverables/content-brief-storyboard-brief.md)
