...
description: Guidelines governing visual and verbal brand identity and voice.
...
problems_solved:
- Prepare a source-grounded Brand Style Guide.
...
skills: []
evaluations:
- Brand Style Guide source-awareness check
trust_tier: trusted
status: beta
license: CC-BY-4.0
related_bundles:
...
content_risk:
  ...
  professional_review:
    status: not_reviewed
    required_qualification: A qualified brand, design, accessibility, intellectual-property, privacy, or legal professional appropriate to the assets and channels.
limitations:
...
Use this bundle to prepare a reviewable **Brand Style Guide** without inventing local facts, configuration, evidence, results, permissions, or authority.
...
- [Brand Style Guide Source-Aware Guide](deliverable.md)
- [Source-aware workflow](workflows/source-aware-workflow.md)
- [Brand Style Guide](deliverables/brand-style-guide-brief.md)
