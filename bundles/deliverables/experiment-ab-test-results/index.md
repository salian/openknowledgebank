---
type: Bundle Index
title: Experiment / A-B Test Design & Results
description: Design and outcome reporting for controlled experiments and A/B tests.
...
- results
aliases:
- Experiment / A-B Test Design & Results
- experiment/A-B test design and results
- A/B test results reports
- A/B test results summary
problems_solved:
- Prepare a source-grounded Experiment / A-B Test Design & Results.
...
skills: []
evaluations:
- Experiment / A-B Test Design & Results source-awareness check
trust_tier: trusted
status: beta
license: CC-BY-4.0
related_bundles:
...
content_risk:
  ...
  professional_review:
    status: not_reviewed
    required_qualification: A qualified experimentation, statistics, analytics, privacy, finance, or domain professional appropriate to the test and decision.
limitations:
...
Use this bundle to prepare a reviewable **Experiment / A-B Test Design & Results** without inventing local facts, configuration, evidence, results, permissions, or authority.
...
- [Experiment / A-B Test Design & Results Source-Aware Guide](deliverable.md)
- [Source-aware workflow](workflows/source-aware-workflow.md)
- [Experiment / A-B Test Design & Results](deliverables/experiment-ab-test-results-brief.md)
