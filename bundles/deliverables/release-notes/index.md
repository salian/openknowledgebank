...
type: Bundle Index
title: Release Notes
description: Documentation summarizing changes included in a software release.
...
- release notes
problems_solved:
- Prepare a source-grounded Release Notes.
...
skills: []
evaluations:
- Release Notes source-awareness check
trust_tier: trusted
status: beta
license: CC-BY-4.0
related_bundles:
...
content_risk:
  ...
  professional_review:
    status: not_reviewed
    required_qualification: A qualified product, engineering, security, technical-writing, legal, or domain reviewer appropriate to the release.
limitations:
...
Use this bundle to prepare a reviewable **Release Notes** without inventing local facts, configuration, evidence, results, permissions, or authority.
...
- [Release Notes Source-Aware Guide](deliverable.md)
- [Source-aware workflow](workflows/source-aware-workflow.md)
- [Release Notes](deliverables/release-notes-brief.md)
