...
description: Analysis of resource capacity needs and growth projections for infrastructure or operations.
...
- capacity/performance optimization reports
problems_solved:
- Prepare a source-grounded Capacity Planning Report.
...
skills: []
evaluations:
- Capacity Planning Report source-awareness check
trust_tier: trusted
status: beta
license: CC-BY-4.0
related_bundles:
...
content_risk:
  ...
  professional_review:
    status: not_reviewed
    required_qualification: A qualified reliability, infrastructure, security, safety, finance, or domain professional appropriate to the service.
limitations:
...
Use this bundle to prepare a reviewable **Capacity Planning Report** without inventing local facts, configuration, evidence, results, permissions, or authority.
...
- [Capacity Planning Report Source-Aware Guide](deliverable.md)
- [Source-aware workflow](workflows/source-aware-workflow.md)
- [Capacity Planning Report](deliverables/capacity-planning-report-brief.md)
