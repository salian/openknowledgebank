---
type: Workflow
title: Customer Satisfaction (CSAT/NPS) Report source-aware workflow
description: Verify-first workflow for producing a reviewable Customer Satisfaction (CSAT/NPS) Report.
---
...
7. Draft the Customer Satisfaction (CSAT/NPS) Report, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
8. Require explicit confirmation before approve, sign, publish, distribute, file, implement, or use the artifact for consequential decisions.
