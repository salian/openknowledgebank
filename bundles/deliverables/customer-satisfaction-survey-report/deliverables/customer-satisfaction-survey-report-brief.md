---
type: Deliverable
title: Customer Satisfaction (CSAT/NPS) Report
description: Review-ready template for Customer Satisfaction (CSAT/NPS) Report evidence, decisions, validation, and controlled next actions.
---
# Customer Satisfaction (CSAT/NPS) Report
...
- Prohibited without explicit confirmation: approve, sign, publish, distribute, file, implement, or use the artifact for consequential decisions.
