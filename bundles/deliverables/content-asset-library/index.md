...
description: Centralized repository of reusable content or brand assets.
...
- sales content library / asset repository
- brand asset library
- final creative asset package
problems_solved:
- Prepare a source-grounded Content / Asset Library.
...
skills: []
evaluations:
- Content / Asset Library source-awareness check
trust_tier: trusted
status: beta
license: CC-BY-4.0
related_bundles:
...
content_risk:
  ...
  professional_review:
    status: not_reviewed
    required_qualification: A qualified digital-asset, records, intellectual-property, privacy, security, or domain professional appropriate to the collection.
limitations:
...
Use this bundle to prepare a reviewable **Content / Asset Library** without inventing local facts, configuration, evidence, results, permissions, or authority.
...
- [Content / Asset Library Source-Aware Guide](deliverable.md)
- [Source-aware workflow](workflows/source-aware-workflow.md)
- [Content / Asset Library](deliverables/content-asset-library-brief.md)
