...
type: Bundle Index
title: Offer Letter
description: Formal document extending an employment offer to a candidate.
...
- offer letters
problems_solved:
- Prepare a source-grounded Offer Letter.
...
skills: []
evaluations:
- Offer Letter source-awareness check
trust_tier: trusted
status: beta
license: CC-BY-4.0
related_bundles:
...
content_risk:
  ...
  professional_review:
    status: not_reviewed
    required_qualification: A qualified HR, employment-law, compensation, payroll, privacy, or tax professional appropriate to the worker and jurisdiction.
limitations:
...
Use this bundle to prepare a reviewable **Offer Letter** without inventing local facts, configuration, evidence, results, permissions, or authority.
...
- [Offer Letter Source-Aware Guide](deliverable.md)
- [Source-aware workflow](workflows/source-aware-workflow.md)
- [Offer Letter](deliverables/offer-letter-brief.md)
