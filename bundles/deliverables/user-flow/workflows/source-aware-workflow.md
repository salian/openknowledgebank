---
type: Workflow
title: User Flow source-aware workflow
description: Verify-first workflow for producing a reviewable User Flow.
---
...
7. Draft the User Flow, including alternatives, risks, dependencies, owners only when evidenced, review points, and stop conditions.
