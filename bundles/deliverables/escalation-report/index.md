---
type: Bundle Index
title: Escalation Report / Summary
description: Documentation of issues escalated beyond frontline handling to other teams.
...
- escalation reports
- escalation summary for support/product teams
- escalation/resolution summary letter
problems_solved:
- Prepare a source-grounded Escalation Report / Summary.
...
skills: []
evaluations:
- Escalation Report / Summary source-awareness check
trust_tier: trusted
status: beta
license: CC-BY-4.0
related_bundles:
...
content_risk:
  ...
  professional_review:
    status: not_reviewed
    required_qualification: A qualified incident, support, privacy, safety, security, or domain professional appropriate to the escalation.
limitations:
...
Use this bundle to prepare a reviewable **Escalation Report / Summary** without inventing local facts, configuration, evidence, results, permissions, or authority.
...
- [Escalation Report / Summary Source-Aware Guide](deliverable.md)
- [Source-aware workflow](workflows/source-aware-workflow.md)
- [Escalation Report / Summary](deliverables/escalation-report-brief.md)
